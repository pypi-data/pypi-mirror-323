...
from aibaba_ai_core.utils.aiter import py_anext

if TYPE_CHECKING:
    from aibaba_ai_core.callbacks.manager import AsyncCallbackManagerForChainRun
...
class RunnableWithFallbacks(RunnableSerializable[Input, Output]):
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from aibaba_ai_core.chat_models.openai import ChatOpenAI
            from aibaba_ai_core.chat_models.anthropic import ChatAnthropic
            ...
            from aibaba_ai_core.output_parser import StrOutputParser
