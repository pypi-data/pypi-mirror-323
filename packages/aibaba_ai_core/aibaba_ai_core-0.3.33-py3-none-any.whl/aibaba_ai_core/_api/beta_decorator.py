...
class AibabaAIBetaWarning(DeprecationWarning):
...
def suppress_aibaba_ai_beta_warning() -> Generator[None, None, None]:
    """Context manager to suppress AibabaAIDeprecationWarning."""
    with warnings.catch_warnings():
        warnings.simplefilter("ignore", AibabaAIBetaWarning)
        yield
...
def warn_beta(
    *,
    ...
    warning = AibabaAIBetaWarning(message)
    warnings.warn(warning, category=AibabaAIBetaWarning, stacklevel=4)


def surface_aibaba_ai_beta_warnings() -> None:
    """Unmute Aibaba AI beta warnings."""
    warnings.filterwarnings(
        "default",
        category=AibabaAIBetaWarning,
    )
