...
class AibabaAIDeprecationWarning(DeprecationWarning):
    """A class for issuing deprecation warnings for Aibaba AI users."""


class AibabaAIPendingDeprecationWarning(PendingDeprecationWarning):
    """A class for issuing deprecation warnings for Aibaba AI users."""
...
def suppress_aibaba_ai_deprecation_warning() -> Generator[None, None, None]:
    """Context manager to suppress AibabaAIDeprecationWarning."""
    with warnings.catch_warnings():
        warnings.simplefilter("ignore", AibabaAIDeprecationWarning)
        warnings.simplefilter("ignore", AibabaAIPendingDeprecationWarning)
        yield
...
def warn_deprecated(
    ...
    *,
    ...
    warning_cls = (
        AibabaAIPendingDeprecationWarning if pending else AibabaAIDeprecationWarning
    )
    warning = warning_cls(message)
    warnings.warn(warning, category=AibabaAIDeprecationWarning, stacklevel=4)


def surface_aibaba_ai_deprecation_warnings() -> None:
    """Unmute Aibaba AI deprecation warnings."""
    warnings.filterwarnings(
        "default",
        category=AibabaAIPendingDeprecationWarning,
    )

    warnings.filterwarnings(
        "default",
        category=AibabaAIDeprecationWarning,
    )
