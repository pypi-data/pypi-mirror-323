...
from aibaba_ai_core.vectorstores.utils import _cosine_similarity as cosine_similarity
from aibaba_ai_core.vectorstores.utils import maximal_marginal_relevance

if TYPE_CHECKING:
    from aibaba_ai_core.indexing import UpsertResponse
