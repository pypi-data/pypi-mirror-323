...
from aibaba_ai_core.utils.pydantic import _IgnoreUnserializable, is_basemodel_subclass

if TYPE_CHECKING:
    from aibaba_ai_core.runnables.base import Runnable as RunnableType
...
def node_data_str(id: str, data: Union[type[BaseModel], RunnableType]) -> str:
    ...
    """
    from aibaba_ai_core.runnables.base import Runnable
...
def node_data_json(
    ...
    """
    from aibaba_ai_core.load.serializable import to_json_not_implemented
    from aibaba_ai_core.runnables.base import Runnable, RunnableSerializable
...
class Graph:
    ...
    def draw_ascii(self) -> str:
        ...
        from aibaba_ai_core.runnables.graph_ascii import draw_ascii
    ...
    def draw_png(
        ...
        """
        from aibaba_ai_core.runnables.graph_png import PngDrawer
    ...
    def draw_mermaid(
        ...
        *,
        ...
        """
        from aibaba_ai_core.runnables.graph_mermaid import draw_mermaid
    ...
    def draw_mermaid_png(
        ...
        *,
        ...
        """
        from aibaba_ai_core.runnables.graph_mermaid import draw_mermaid_png
