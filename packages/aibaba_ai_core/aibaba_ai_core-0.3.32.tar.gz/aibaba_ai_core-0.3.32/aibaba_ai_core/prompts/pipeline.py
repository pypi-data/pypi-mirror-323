...
from aibaba_ai_core.prompts.chat import BaseChatPromptTemplate
...
@deprecated(
    ...
    message=(
        ...
        "https://docs.aibaba.world/api_reference/core/prompts/aibaba_ai_core.prompts.pipeline.PipelinePromptTemplate.html"
    ),
)
