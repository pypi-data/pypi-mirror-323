...
from iqm.pulse.gates.conditional import CCPRX_Composite
...
from iqm.pulse.gates.prx import PRX_DRAGCosineRiseFall, PRX_DRAGCosineRiseFallSX, PRX_DRAGGaussian, PRX_DRAGGaussianSX
from iqm.pulse.gates.reset import Reset_Conditional, Reset_Wait
from iqm.pulse.gates.rz import RZ_ACStarkShift_CosineRiseFall, RZ_Virtual
from iqm.pulse.gates.sx import SXGate
from iqm.pulse.gates.u import UGate
...
_default_operations: QuantumOpTable = {
    ...
    for op in [
        ...
        QuantumOp(
            ...
            implementations={"prx_composite": CCPRX_Composite},
        ),
        QuantumOp(
            "reset",
            0,
