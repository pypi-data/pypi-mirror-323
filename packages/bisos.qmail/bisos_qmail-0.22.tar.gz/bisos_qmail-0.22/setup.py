...
# ./pypiUploadVer EXISTED -- forPypiVersion=0.22 -- forSysVersion=0.2 -- constant=NA
def pkgVersion():
        return '0.22'
...
scripts = [ 
'bin/notqmailMua-sysd.cs',
'bin/qmailAdmin.cs',
'bin/qmail-assemble.cs',
'bin/qmail-binsPrep.cs',
'bin/qmailConfig.cs',
'bin/qmailControl.cs',
