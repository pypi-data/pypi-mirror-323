...
class Server(WebsocketServer):
  ...
  def _parse_request(self, message: str) -> tuple[WakewordEngine | None, DetectorConsumer | None]:
    request = InitMessage.create(message)
  ...
  async def _handle_audio_data(
    ...
    try:
      ...
      async for chunk in websocket:
        ...
        if detector_consumer:
          sound, score = detector_consumer.process_raw(chunk)
  ...
  async def _handle_messages(
    ...
    try:
      ...
      wakeword_engine, detector_consumer = self._parse_request(message)
