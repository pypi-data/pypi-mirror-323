...
def midi_to_tokens(input_midi,
    ...
    if verbose:
        ...
        print('Source MIDI omposition has', len(cscore), 'chords')
        print('-' * 70)
        print('Encoded sequence has', notes_counter, 'pitches')
        print('Encoded sequence has', i, 'chords')
        print('-' * 70)
...
def midi_to_chords(input_midi,
    ...
    if verbose:
        ...
        print('Source MIDI omposition has', len(cscore), 'chords')
        print('-' * 70)
        print('Encoded sequence has', pitches_counter, 'pitches')
        print('Encoded sequence has', i, 'chords')
        print('-' * 70)
        print('Final encoded sequence has', len(output), 'tokens')
        print('=' * 70)
