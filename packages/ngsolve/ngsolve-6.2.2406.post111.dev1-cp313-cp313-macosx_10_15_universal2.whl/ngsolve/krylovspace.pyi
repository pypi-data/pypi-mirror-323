...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('fig', 'sol', 'plt', 'plotrates', 'callback', 'ax', 'clear_output', 'tol', 'printrates', 'display', 'ress', 'iterations', 'mat', 'callback_sol', 'its', 'pre', 'atol', 'residuals', '_final_residual', 'maxiter')
