...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_lin_solver_cls', '_lin_solver_args', 'time', 'bfmstar', 'dt', 'gfu_old', 'c')
...
class ImplicitEuler:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_lin_solver_cls', '_lin_solver_args', 'gfu_old', 'time', 'bfmstar', 'dt', 'c')
    def Integrate(self, u_start: ngsolve.comp.GridFunction, end_time: float, start_time: typing.Optional[float] = None, newton_args: typing.Optional[dict] = None, callback: typing.Optional[typing.Callable] = None):
        ...
    def Step(self, u: ngsolve.comp.GridFunction, dt: typing.Optional[float] = None, newton_args: typing.Optional[dict] = None):
        ...
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('_lin_solver_cls', '_lin_solver_args', 'gfu_old', 'time', 'bfmstar', 'gfa_old', 'dt', 'gfv_old', 'c')
