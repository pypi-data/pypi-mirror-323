...
class ImageConverter:
    ...
    def validate_opencv_image(image: np.ndarray):
        ...
        return ImageConverter.validate_numpy_image(image)
    ...
    def numpy_image_to_pil(image: np.ndarray):
        ...
        """
        ImageConverter.validate_numpy_image(image)
    ...
    def pil_image_to_numpy(image: Image.Image):
        ...
        """
        ImageConverter.validate_pillow_image(image)
    ...
    def base64_image_to_pil(image):
        ...
        """
        ImageConverter.validate_base64_image(image)
    ...
    def opencv_image_to_numpy(image: np.ndarray):
        ...
        into a numpy array first.
        """
        ImageConverter.validate_opencv_image(image)
