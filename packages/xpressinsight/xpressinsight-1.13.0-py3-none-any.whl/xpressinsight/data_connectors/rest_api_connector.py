...
from typing import Dict, Sequence, Union, Type, Iterable, List, Optional, Tuple, TypeVar
import sys
...
class RestApiConnector(TableConnector):
    ...
    def __init__(self, data_container: EntitiesContainer, source: ScenarioData, source_schema: ModelSchema,
        ...
        super().__init__(data_container, fetch_individual_series=True, slow_tasks_monitor=slow_tasks_monitor)
