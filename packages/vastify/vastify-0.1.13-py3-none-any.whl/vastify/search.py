...
def get_active_instance_with_requirements(requirements: dict):
    ...
    for instance_id in instance_ids:
        ...
        logging.info('Found existing instance with state:', instance_state)

        if matches_requirements(instance_state, requirements):
            logging.info(f'Existing instance matches requirements {instance_id} ({instance_state["SSH Addr"]}:{instance_state["SSH Port"]})')
