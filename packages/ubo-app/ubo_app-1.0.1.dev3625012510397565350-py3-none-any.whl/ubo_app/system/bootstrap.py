...
def install_nodogsplash() -> None:
    """Install nodogsplash."""
    stdout.write('Installing nodogsplash...\n')
    stdout.flush()
    subprocess.run(  # noqa: S603
        [
            Path(__file__).parent.joinpath('install_nodogsplash.sh').as_posix(),
        ],
        check=True,
    )
    stdout.write('Done installing nodogsplash\n')
    stdout.flush()
