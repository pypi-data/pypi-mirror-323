...
** This File: /bisos/git/auth/bxRepos/bisos-pip/marmee/py3/bin/marmeeDaemonSysd.cs
...
#+end_org """
import typing
csInfo: typing.Dict[str, typing.Any] = { 'moduleName': ['marmeeDaemonSysd'], }
csInfo['version'] = '202305114317'
csInfo['status']  = 'inUse'
csInfo['panel'] = 'marmeeDaemonSysd-Panel.org'
...
sysdConfigMarmee = marmeeDaemonSysd.sysdConfigMarmee
sysdUnitMarmee = marmeeDaemonSysd.sysdUnitMarmee
...
####+END:
        ...
        marmeeDaemonSysd.examples_csu(sectionTitle="default")
