...
class UpgradeAsaDeviceInput(BaseModel):
    ...
    software_version: StrictStr = Field(description="The target ASA firmware version to upgrade the device to. This field cannot be blank.", alias="softwareVersion")
