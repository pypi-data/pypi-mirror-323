...
### Android AiO installer:

Für Android nutzer habe ich eine custom Termux Version erstellen, welche nach dem Installieren beim erstmaligen starten eine (ca. 100mb große) bootstrap File runter läd. Im Anschluss startet der vxparser beim start von Termux direkt mit.

[vxparser_termux_0.83.apk](https://github.com/Mastaaa1987/termux-vxparser/releases/download/v0.8.3/vxparser_termux_0.83.apk)

- Um den vxparser ggf. zu updaten muss ausschließlich die Termux App Daten gelöscht werden & die bootstrap File erneut herunter geladen werden.
