...
Clone the repository and install using Poetry or pip:
...
# Install with both streamlit and API
poetry install --with streamlit,api

# Install everything (including dev dependencies)
poetry install --with streamlit,api,dev
...
# Install with both streamlit and API
pip install ".[streamlit,api]"

# Install everything (including dev dependencies)
pip install ".[streamlit,api,dev]"
