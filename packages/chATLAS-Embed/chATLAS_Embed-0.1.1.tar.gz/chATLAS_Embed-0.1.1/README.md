...
```python
from chATLAS_Embed import SentenceTransformerEmbedding, RecursiveTextSplitter, PostgresParentChildVectorStore
...
parent_splitter = RecursiveTextSplitter(max_tokens=512)
child_splitter = RecursiveTextSplitter(max_tokens=128)
