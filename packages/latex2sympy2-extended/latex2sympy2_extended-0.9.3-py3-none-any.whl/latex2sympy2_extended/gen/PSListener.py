...
class PSListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by PSParser#just_letter_e.
    def enterJust_letter_e(self, ctx:PSParser.Just_letter_eContext):
        pass

    # Exit a parse tree produced by PSParser#just_letter_e.
    def exitJust_letter_e(self, ctx:PSParser.Just_letter_eContext):
        pass
