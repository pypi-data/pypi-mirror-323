...
class PostgresManager:
    ...
    def ensure_connection(self) -> None:
        ...
        # If localhost, try to find existing postgres containers first
        if (self.host == "localhost" or self.host == "127.0.0.1"):
            ...
            try:
                # Look specifically for our container first
                try:
                    ...
                    # Container not found or not running, look for any postgres containers
                ...
                # If we get here and no existing containers work, set up a new one
                if self.host == "localhost" or self.host == "127.0.0.1":
