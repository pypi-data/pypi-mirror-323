...
class PostgresManager:
    ...
    def ensure_connection(self) -> None:
        ...
        # If we get here, either localhost setup failed or a different host was specified
