...
def download_issues_from_new_sync(
    ...
    Args:
        ...
        include_fields (list[JiraFieldIdentifier]): A list of fields to include in the raw issues
        exclude_fields (list[JiraFieldIdentifier]): A list of fields to exclude in the raw issues
