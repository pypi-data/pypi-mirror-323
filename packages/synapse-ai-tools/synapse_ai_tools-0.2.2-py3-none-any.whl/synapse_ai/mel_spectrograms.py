...
def graph_mel_spectrogram(spectrogram:np.ndarray, output_dir:str, fig_size:tuple[int, int]=(12,6), name:str='Spectrogram', cmap:str='magma', show:bool=False, save:bool=True) -> None:
    """
    ...
    Args:
        ...
        show (bool, optional): If True, displays the plot using `plt.show()`. Defaults to False.
        save (bool, optional): If True, saves the spectrogram image to `output_dir` with the specified `name`. Defaults to True.
