...
print(screens)
from computer_use_ootb.computer_use_demo.loop import (
    PROVIDER_TO_DEFAULT_MODEL_NAME,
    APIProvider,
    sampling_loop_sync,
)

from computer_use_ootb.computer_use_demo.tools import ToolResult
from computer_use_ootb.computer_use_demo.tools.computer import get_screen_details
