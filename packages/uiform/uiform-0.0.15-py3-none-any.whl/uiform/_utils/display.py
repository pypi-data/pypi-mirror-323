...
def display_metrics(metrics: Metrics, completion_token_price: Optional[float] = None, input_token_price: Optional[float] = None) -> None:
    """
    ...
    if completion_token_price is not None and input_token_price is not None:
        table.add_row(
            "Input Cost", 
