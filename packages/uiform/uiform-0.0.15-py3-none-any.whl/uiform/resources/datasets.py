...
class Datasets(SyncAPIResource, BaseDatasetsMixin):
    ...
    def pprint(self, dataset_path: Path, completion_token_price: Optional[float] = None, input_token_price: Optional[float] = None) -> Metrics:
        ...
        display_metrics(computed_metrics, completion_token_price=completion_token_price, input_token_price=input_token_price)
