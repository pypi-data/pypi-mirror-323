...
class PydanticToHFDatasets(abc.ABC):
    ...
    def model_cls_to_features(cls, entity_type: type[pydantic.BaseModel]) -> datasets.Features:
        ...
        :returns: `datasets.Features` instance for use in HF `datasets.Dataset`.
        """
    ...
    def _annotation_to_values(
        ...
        :returns: `datasets.Value` or `datasets.Sequence` instance generated from specified annotation.
        """
    ...
    def model_to_dict(cls, model: pydantic.BaseModel | None) -> Any:
        ...
        :returns: Entity as dict aligned with the `datasets.Dataset` schema generated by
