...
class SeleniumClient:
    ...
    async def scrape(self, root_url:str) -> ParsedResponse:
        ...
        params = ScrapeRequest(url=root_url).model_dump(exclude_none=True)
        results = await http_post_async(url, data=params)
        return results.json()
    ...
    async def get_crawl_job(self, job_id:str):
        ...
        url = f'http://localhost:12028/api/v1/crawl/job/{job_id}'
