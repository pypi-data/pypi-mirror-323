...
def add_owner(request, token):
    ...
    if not created:
        ...
        messages.success(
            request,
            _("Successfully enabled owner %(owner_name)s")
            % {"owner_name": owner.character_name},
        )
    else:
        messages.success(
            request,
            _("Successfully created owner %(owner_name)s")
            % {"owner_name": owner.character_name},
        )
