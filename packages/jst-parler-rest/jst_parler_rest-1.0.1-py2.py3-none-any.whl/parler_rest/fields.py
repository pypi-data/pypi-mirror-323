...
class TranslatedFieldsField(serializers.Field):
    ...
    default_error_messages = dict(
        serializers.Field.default_error_messages,
        **{
...
class TranslatedField(serializers.Field):
    ...
    def get_attribute(self, instance):
        ...
        model = instance._parler_meta.get_model_by_field(
            self.source
        )  # This already validates the fields existance
        ...
        for (
            translation
        ) in translations.all():  # Allow prefetch_related() to do it's work
