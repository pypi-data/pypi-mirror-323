...
class Project(BaseModel):
    ...
    invitations: Optional[Dict[str, Any]] = None
    ...
    __properties: ClassVar[List[str]] = ["project_id", "name", "description", "collection", "owner_id", "users", "invite_link_id", "invitations", "predefined_queries", "custom_instructions", "model", "comments", "library", "updated_at"]
