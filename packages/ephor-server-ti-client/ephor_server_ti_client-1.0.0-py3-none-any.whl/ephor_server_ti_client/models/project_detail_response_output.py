...
class ProjectDetailResponseOutput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["project_id", "owner_id", "name", "description", "collection", "library", "users", "predefined_queries", "custom_instructions", "model", "invite_link_id", "invitations", "comments", "conversations", "status"]
