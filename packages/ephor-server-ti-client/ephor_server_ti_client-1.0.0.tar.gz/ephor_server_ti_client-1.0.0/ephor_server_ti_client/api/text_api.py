...
class TextApi:
    ...
    @validate_call
    def text_qna_api_v1_interact_tasks_text_post_1(
        self,
        ...
        _param = self._text_qna_api_v1_interact_tasks_text_post_1_serialize(
    ...
    @validate_call
    def text_qna_api_v1_interact_tasks_text_post_1_with_http_info(
        self,
        interact_request: InteractRequest,
    ) -> ApiResponse[object]:
        """Text Qna
    ...
    @validate_call
    def text_qna_api_v1_interact_tasks_text_post_1_without_preload_content(
        self,
        interact_request: InteractRequest,
    ) -> RESTResponseType:
        """Text Qna
    ...
    def _text_qna_api_v1_interact_tasks_text_post_1_serialize(
        self,
        interact_request,
        _request_auth,
        _content_type,
