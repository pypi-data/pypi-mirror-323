...
class SecondBrainInput(BaseModel):
    """
    SecondBrainInput
    """ # noqa: E501
    ...
    nodes: Optional[List[SecondBrainNodeInput]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SecondBrainInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SecondBrainInput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "nodes": [SecondBrainNodeInput.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None,
