...
class ProjectListResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["project_id", "owner_id", "name", "description", "is_admin", "access_level", "collection", "users", "invite_link_id", "invitations", "predefined_queries", "custom_instructions", "comments", "model", "library_id", "updated_at", "status"]
