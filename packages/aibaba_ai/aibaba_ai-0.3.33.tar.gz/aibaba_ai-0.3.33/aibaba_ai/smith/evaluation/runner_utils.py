...
from aibaba_ai_core.outputs import ChatResult, LLMResult
from aibaba_ai_core.runnables import Runnable, RunnableConfig, RunnableLambda
from aibaba_ai_core.runnables import config as runnable_config
from aibaba_ai_core.runnables import utils as runnable_utils
    ...
    def _collect_metrics(self) -> Tuple[Dict[str, _RowResult], Dict[str, Run]]:
        ...
        for c in self.configs:
            for callback in cast(list, c["callbacks"]):
                ...
                elif isinstance(callback, AibabaAITracer):
