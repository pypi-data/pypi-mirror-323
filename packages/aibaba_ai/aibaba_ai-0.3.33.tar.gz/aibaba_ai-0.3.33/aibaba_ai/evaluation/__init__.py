...
Aibaba AI primitives such as language models and chains.
...
To load one of the Aibaba AI HuggingFace datasets, you can use the :func:`load_dataset <langchain.evaluation.loading.load_dataset>` function with the
