...
long_description = (this_directory / "README.md").read_text(encoding="utf-8")  # Ensure proper encoding

setup(
    name='Topsis_Abhiraj_Singh_Jhajj_102217094',  # Unique name for PyPI package
    version='1.0.0',  # Version of the package
    packages=find_packages(),  # Automatically discover all packages
    install_requires=[
        'pandas>=1.0.0',  # Required dependencies
        'numpy>=1.19.0',
    ],
    ...
    entry_points={
        'console_scripts': [
            'topsis=Topsis_Abhiraj_Singh_Jhajj_102217094.main:main',  # Command line entry point
        ],
    },
)
