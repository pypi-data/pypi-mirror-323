...
Welcome to `aelcha` contributor's guide.
...
If you experience bugs or general issues with `aelcha`, please have a look
...
You can help improve `aelcha` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`aelcha` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `aelcha`'s files. While this mechanism can
...
```
conda create -n aelcha python=3 six virtualenv pytest pytest-cov
conda activate aelcha
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/aelcha.git
   cd aelcha
   ```
...
5. Install [pre-commit]:
   ...
   `aelcha` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/aelcha
[issue tracker]: https://github.com/<USERNAME>/aelcha/issues
