...
from heaobject.util import system_timezone
    ...
    service.MONGODB_ORGANIZATION_COLLECTION: [
        {
            ...
            "owner": NONE_USER,
            "created": datetime(2021, 12, 2, 17, 31, 15, 630000, tzinfo=system_timezone()),
            "modified": datetime(2021, 12, 2, 17, 31, 15, 630000, tzinfo=system_timezone()),
            "invites": [],
            "shares": [{
