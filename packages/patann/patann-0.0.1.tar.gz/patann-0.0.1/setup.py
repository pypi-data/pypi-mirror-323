...
setuptools.setup(
    ...
    description="PatANN is a massively parallel, distributed, and scalable in-memory/on-disk vector database library for efficient nearest neighbor search using patterns across large-scale datasets, developed by mesibo, inc.",
