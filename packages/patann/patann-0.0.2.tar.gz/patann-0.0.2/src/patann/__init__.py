...
# Copyright notice placeholder - see copyright.py
#         
...
# python reports different machine() on windows (AMD64) or cygwin (x86_64) and hence normallizing to x86_64
...
def copy_files():
    ...
    import shutil
#print("trying to install " + patannpath + " to " + pypath);
    try:
...
def getPatANNInstance():
    return createPatANNInstance();
