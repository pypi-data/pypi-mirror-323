...
`).map(a=>t.jsx("div",{children:a},Math.random()))})}return n()}function ft(e){function n(){return e.data.url?t.jsx("div",{style:{maxWidth:"100%"},children:t.jsx(P,{href:e.data.url,imodal:!!e.data.modal,children:e.data.icon?t.jsx(C,{icon:e.data.icon}):e.data.url})}):t.jsx("span",{children:"-"})}return n()}function gt(e){function n(){return t.jsx("iframe",{src:e.data.url,width:"100%",height:500,style:{border:0}})}return n()}function xt(e){const n=Math.random();I.useEffect(()=>{new QRCode(document.getElementById(n),{text:e.data.text,width:128,height:128,colorDark:"#333333",colorLight:"#ffffff",correctLevel:QRCode.CorrectLevel.H})},[]);function a(){return t.jsx("div",{id:n})}return a()}function yt(e){function n(){const a={color:"white",backgroundColor:p.colors.highlight,margin:-20,textAlign:"center",paddingTop:20,paddingBottom:70},r={fontSize:"4rem",fontWeight:"bold",marginTop:25},i={fontSize:"1.2rem",maxWidth:200,margin:"auto"};if(e.data)return t.jsxs("div",{className:"indicators",style:a,children:[t.jsx("h1",{"data-label":T(e.data.title),children:e.data.title}),t.jsx(V,{width:300,children:e.data.items.map(o=>t.jsxs("div",{children:[t.jsx("div",{style:r,children:G(o.value)}),t.jsx("div",{style:i,children:o.name})]},Math.random()))},Math.random()),t.jsx("div",{className:"actions",children:e.data.actions.map(o=>t.jsx(P,{href:z(o.url),label:o.label,modal:o.modal,children:o.label},Math.random()))})]})}return n()}function vt(e){function n(){return t.jsx(V,{width:400,children:e.data.items.map((a,r)=>t.jsx("div",{children:t.jsx(x,{data:a})},Math.random()))})}return n()}function bt(e){function n(){return t.jsxs("div",{children:[t.jsx("h2",{align:"center",children:e.data.title}),t.jsx("div",{style:{fontSize:"8rem",textAlign:"center",color:"#5470c6"},children:e.data.value})]})}return n()}function Ne(e){const n=Math.random();var a=!1;const r="rgb(219, 237, 255)",i="rgb(89, 154, 242)",o="rgb(246, 123, 135)",s="rgb(92, 160, 93)",d=[],c=[],u=["DOM","SEG","TER","QUA","QUI","SEX","SAB"],[l,h]=I.useState(e.data),[m,w]=I.useState(1);F(`
  ...
  `);function y(g){const N=document.getElementsByName(e.data.input_name)[0].closest("form");var O=N?Q(e.data.url,N,e.data.input_name):e.data.url,L=O.indexOf("?")>0?"&":"?";O=O+L+"week="+(g||m),R("GET",O,function(Z){console.log(Z),h(Z)})}function j(){m>1&&(y(m-1),w(m-1))}function q(){y(m+1),w(m+1)}I.useEffect(()=>{document.getElementById(n).querySelector(".input-periodo-2").checked=!0,document.getElementById(n).querySelector(".input-periodo-3").checked=!0,window["reload-"+e.data.input_name+"-field"]=y},[]);function k(g,N){return l.readonly?g==null?r:i:g==null?l.selectable==null?r:l.selectable.indexOf(N)>=0?s:r:g.text==null?i:o}function B(g){a=!0}function D(g){a=!1,document.getElementById("input"+n).value=JSON.stringify({select:d,deselect:c})}function v(g){if(!l.readonly&&!(e.data.single_selection&&S().length>0&&g.target.style.backgroundColor!=i)&&a&&g.target.tagName!="I"&&g.target.style.backgroundColor!=o){const N=g.target.dataset.day.split("/"),O=g.target.dataset.time.split(":"),L=g.target.dataset.day+" "+g.target.dataset.time;if(new Date(parseInt(N[2],10),parseInt(N[1],10)-1,parseInt(N[0],10),parseInt(O[0],10),parseInt(O[1],10))>new Date||e.data.weekly){if(e.data.single_selection){for(;c.length>0;)c.pop();for(;d.length>0;)d.pop()}(g.target.style.backgroundColor==r||g.target.style.backgroundColor==s)&&(l.selectable==null||l.selectable.indexOf(L)>=0)?(g.target.style.backgroundColor=i,console.log("MARCOU",g.target.dataset.day,g.target.dataset.time),d.push([g.target.dataset.day,g.target.dataset.time])):(l.selectable==null?g.target.style.backgroundColor=r:g.target.style.backgroundColor=l.selectable.indexOf(L)>=0?s:r,console.log("DEMARCOU",g.target.dataset.day,g.target.dataset.time),c.push([g.target.dataset.day,g.target.dataset.time]))}}}function M(g){const N=g.split("/");return u[new Date(parseInt(N[2],10),parseInt(N[1],10)-1,parseInt(N[0],10)).getDay()]}function S(){const g=[];return document.getElementById(n).querySelectorAll("td").forEach(function(N){N.style.backgroundColor==i&&g.push(N.dataset.day,N.dataset.time)}),g}function f(g){if(g=parseInt(g.split(":")[0]),g>=0&&g<6)return 1;if(g>=6&&g<12)return 2;if(g>=12&&g<18)return 3;if(g>=18&&g<24)return 4}function b(g){const N=f(g);var O="period-"+N;return _(N)||(O+=" hidden"),O}function E(g,N){document.getElementById(n).querySelectorAll(".period-"+g).forEach(function(O){O.style.display=N?"table-row":"none"})}function _(g){return g==2||g==3}function A(){const g={overflowX:"auto"},N={width:"100%",borderSpacing:0,borderCollapse:"collapse",marginTop:15,marginBottom:15},O={border:"solid 4px white",userSelect:"none"};return t.jsxs("div",{id:n,style:g,className:"scheduler",children:[e.data.title&&t.jsx("h2",{children:e.data.title}),t.jsx("input",{id:"input"+n,type:"hidden",name:e.data.input_name}),t.jsx("table",{style:{width:"100%"},children:t.jsx("tbody",{children:t.jsxs("tr",{children:[e.data.url&&m>1&&t.jsx("td",{align:"left",width:10,children:t.jsx(W,{primary:!0,icon:"chevron-left",onClick:()=>j()})}),t.jsx("td",{align:"center",children:t.jsxs("div",{className:"periods",children:[t.jsx("input",{className:"input-periodo-1",type:"checkbox","data-label":"madrugada",onChange:L=>E(1,L.target.checked)})," ",t.jsx("span",{children:"Madrugada"}),t.jsx("input",{className:"input-periodo-2",type:"checkbox","data-label":"manha",onChange:L=>E(2,L.target.checked)})," ",t.jsx("span",{children:"Manhã"}),t.jsx("input",{className:"input-periodo-3",type:"checkbox","data-label":"tarde",onChange:L=>E(3,L.target.checked)})," ",t.jsx("span",{children:"Tarde"}),t.jsx("input",{className:"input-periodo-4",type:"checkbox","data-label":"noite",onChange:L=>E(4,L.target.checked)})," ",t.jsx("span",{children:"Noite"})]})}),e.data.url&&t.jsx("td",{align:"right",width:10,children:t.jsx(W,{primary:!0,icon:"chevron-right",onClick:()=>q()})})]})})}),t.jsxs("table",{style:N,onMouseDown:B,onMouseUp:D,children:[t.jsx("thead",{children:t.jsx("tr",{children:l.matrix[0].map(function(L){return t.jsxs("th",{className:"bold",style:O,children:[M(L.text),!e.data.weekly&&t.jsx("br",{}),!e.data.weekly&&L.text]},Math.random())})})}),t.jsx("tbody",{children:l.matrix.map(function(L,Z){if(Z>0)return t.jsx("tr",{className:b(L[0].text),children:L.map(function(J,se){if(se==0)return t.jsx("th",{className:"bold",align:"center",style:O,children:J.text},Math.random());{const ve=l.matrix[0][se].text+" "+L[0].text,qe={backgroundColor:k(J,ve),border:"solid 4px white",cursor:"pointer"};return t.jsx("td",{align:"center",style:qe,onMouseDown:v,onMouseLeave:v,onMouseUp:v,"data-day":l.matrix[0][se].text,"data-time":L[0].text,"data-label":ve,children:J&&J.text&&t.jsx(wt,{text:J.text,children:t.jsx(C,{icon:J.icon||"x",style:{color:"white",cursor:"help"}})})},Math.random())}})},Math.random())})})]})]})}return A()}function wt(e){function n(){return F(`
      .tooltip {
        position: relative;
