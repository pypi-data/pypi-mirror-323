...
def call_rate_limiter(method, params, url_1_only=True, url_2_only=False, **kwargs):
    return get_async_response(async_call_rate_limiter,method=method, params=params, url_1_only=url_1_only, url_2_only=url_2_only, **kwargs)

def make_rate_limited_call(method, params, url_1_only=True, url_2_only=False, **kwargs):
    return get_async_response(async_make_rate_limited_call(method=method, params=params, url_1_only=url_1_only, url_2_only=url_2_only, **kwargs))
