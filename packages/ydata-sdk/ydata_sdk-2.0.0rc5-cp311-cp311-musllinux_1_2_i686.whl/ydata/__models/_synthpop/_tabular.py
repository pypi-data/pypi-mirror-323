...
from ydata.__models._synthpop._preprocess import Preprocessor
from ydata.__models._synthpop.maps import (ENABLED_DATATYPES, METHOD_TO_TYPE_TO_FUNCTION, METHODS_MAP, NA_METHODS,
                                           SYNTHPOP_FLAVOR, Smoothing)
...
methods = METHODS_MAP[SYNTHPOP_FLAVOR.TAB]
methods_map = METHOD_TO_TYPE_TO_FUNCTION[SYNTHPOP_FLAVOR.TAB]


# #@typechecked
class Synthpop(BaseSynthesizer):
    __name__ = "Synthpop"
    FLAVOR = SYNTHPOP_FLAVOR.TAB
    DEVICE = Device.CPU
    ...
    def __init__(
        ...
        """Tabular Synthpop initialization.
    ...
    def fit(self, X: DataFrame,
            ...
            method: Optional[Union[list,
                                   METHODS_MAP[SYNTHPOP_FLAVOR.TAB]]] = None,
            cont_na: dict | None = None,
            bootstrapping_cols: list[str] | None = None) -> Synthpop:
        ...
        """
        # More details can be found in this link: https://cran.r-project.org/web/packages/synthpop/synthpop.pdf
    ...
    def __validate_datatypes(columns):
        validate_datatypes(ENABLED_DATATYPES[SYNTHPOP_FLAVOR.TAB], columns)
