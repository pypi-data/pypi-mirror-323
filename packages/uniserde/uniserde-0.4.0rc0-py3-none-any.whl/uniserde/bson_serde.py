...
from . import bson_deserialize, bson_serialize, case_convert, schema_mongodb, utils
...
class BsonSerde:
    ...
    def __init__(
        ...
        *,
        ...
        `python_attribute_name_to_doc_name`: A function that derives the name
            ...
            the Python class. The default makes no changes, except that fields
            named `id` are stored as `_id`.
        ...
        self._serialization_cache = bson_serialize.BsonSerializationCache(
            custom_handlers={
                key: lambda _, value, as_type: handler(self, value, as_type)
        ...
        self._mongodb_schema_converter = schema_mongodb.MongodbSchemaConverter(
            custom_handlers={
                key: lambda _, as_type: handler(self, as_type)
    ...
    def as_bson(
        ...
        *,
        ...
        handler = self._serialization_cache._get_handler(
            as_type,
            utils.get_type_key(as_type),
        )

        return handler(self._serialization_cache, value, as_type)
    ...
    def from_bson(
        ...
        return handler(self._deserialization_cache, value, as_type)
    ...
    def as_mongodb_schema(
        ...
        """
        return self._mongodb_schema_converter._process(as_type)
