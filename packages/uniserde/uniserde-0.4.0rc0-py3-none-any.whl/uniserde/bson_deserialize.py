...
class BsonDeserializationCache(serde_cache.SerdeCache[Bsonable, t.Any]):
    """
    ...
    def __init__(
        ...
        *,
        custom_handlers: dict[
            t.Type,
            t.Callable[
                [BsonDeserializationCache, t.Any, t.Type],
                Bsonable,
            ],
        ] = {},
        lazy: bool = False,
    ...
    _build_field_by_field_class_handler = (
        json_deserialize.JsonDeserializationCache._build_field_by_field_class_handler
    )

    _build_field_by_field_class_handler_without_children = json_deserialize.JsonDeserializationCache._build_field_by_field_class_handler_without_children
