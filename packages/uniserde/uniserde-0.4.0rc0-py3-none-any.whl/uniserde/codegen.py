...
class Codegen:
    def __init__(self) -> None:
        ...
        self._external_processors: list[t.Type] = []
    ...
    def get_external_processor_name(self, type_key: t.Type) -> str:
        """
        ...
        try:
            return f"external_{self._external_processors.index(type_key) + 1}"
        except ValueError:
            pass

        # Register the processor
        self._external_processors.append(type_key)
        return f"external_{len(self._external_processors)-1}"

    def external_processors(self) -> t.Iterable[tuple[t.Type, str]]:
        """
