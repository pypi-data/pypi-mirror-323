...
def main() -> None:
    ...
    handler_builder = serde._serialization_cache._get_handler_builder(Model, Model)
    ...
    # Deserialization
    handler_builder = serde._deserialization_cache._get_handler_builder(Model, Model)
