...
def identity_with_id_exception(name: str) -> str:
    """
    Keeps the name the same, with one exception: if the name is "id", it is
    converted to "_id" to match what IDs are called in MongoDB.
    """
    if name == "id":
        return "_id"
