...
from langtxt.core.text_splitters.utils import (
    merge_splits,
    split_by_char,
    split_by_fns,
    split_by_sep,
...
class TokenTextSplitter:
    ...
    **Example**
    ...
    .. code-block:: python
        ...
        from langtxt.text_splitters import TokenTextSplitter
    ...
    def from_text(self, text: str) -> List[str]:
        ...
        **Example**
        ...
        .. code-block:: python
            ...
            chunks = splitter.from_text("Langtxt AI is a data library to build context-aware AI applications")
        """
