...
from langtxt.core.embeddings import BaseEmbedding
from langtxt.core.utils.pairwise import cosine_similarity
...
class SemanticSplitter(BaseModel):
    ...
    **Example**
    ...
    .. code-block:: python
        ...
        from langtxt.text_splitters import SemanticSplitter
