...
from langtxt.core.document import Document
from langtxt.core.embeddings import BaseEmbedding, Embedding
...
class WatsonxEmbedding(BaseModel, BaseEmbedding):
    ...
    **Example**
    ...
    .. code-block:: python
        ...
        from langtxt.embeddings import WatsonxEmbedding
    ...
    def get_query_embedding(self, query: str) -> Embedding:
        ...
        **Example**
        ...
        .. code-block:: python
            ...
            embedded_query = watsonx_embedding.get_query_embedding("Langtxt AI is a data framework to build context-aware AI applications")
        """
