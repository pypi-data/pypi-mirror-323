...
class HuggingFaceEmbedding(BaseModel, BaseEmbedding):
    ...
    **Example**
    ...
    .. code-block:: python
        ...
        from langtxt.embeddings import HuggingFaceEmbedding
    ...
    def get_query_embedding(self, query: str) -> Embedding:
        ...
        **Example**
        ...
        .. code-block:: python
            ...
            embedded_query = embedding.get_query_embedding("Langtxt AI is a data framework to build context-aware AI applications")
        """
