...
class BTrainer:
    ...
    def train_eval_s(self,
        ...
        for epoch in range(epochs):
            ...
            if self.__stop_by_acc_delta is not None:
                if self.__stop_by_acc_delta(train_acc, val_acc):
    ...
    def set_stop_by_acc_delta(self, rounds=10, delta=0.1):
        '''
        请在训练前设置set_stop_by_acc_delta
        :param rounds: 连续rounds次都是train_acc - val_acc > delta
        :return:
        '''
    ...
    def set_stop_by_loss_delta(self, rounds=10, delta=0.003):
        '''
        请在训练前设置set_stop_by_loss_delta
        :param rounds: 连续rounds次都是|before_loss - now_loss| <= delta
        :return:
        '''
