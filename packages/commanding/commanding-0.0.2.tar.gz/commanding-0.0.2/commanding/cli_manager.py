...
def info(self, *values, between: str = " "):
    CLIManager().info(*values, between=between)

def warn(self, *values, between: str = " "):
    CLIManager().warn(*values, between=between)

def error(self, *values, between: str = " "):
    CLIManager().error(*values, between=between)

def debug(self, *values, between: str = " "):
    CLIManager().debug(*values, between=between)