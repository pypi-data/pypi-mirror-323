...
class BrightStarCatalog(Catalog):
    ...
    def _create_from_database(self):
        ...
        for line in open(catalog, "rt"):
            ...
            id_num.append(id)
            ra.append(Angle((ra_hrs, ra_min, ra_sec), unit="hourangle").to("deg").value)
            dec.append(Angle((dec_deg, dec_min, dec_sec), unit=u.deg).value)
            mag.append(m)
            pmra.append(pmr)
            pmdec.append(pmd)
...
class GaiaCatalog(Catalog):
    ...
    def _create_from_database(self):
        ...
        selection_str = (
            ...
            " gaia.ref_epoch, gaia.pmra, gaia.pmdec, gaia.phot_g_mean_flux,"
            " gaia.phot_g_mean_mag, gaia.teff_gspphot"
        ...
        log.debug("\tselection string: {}" + selection_str)
