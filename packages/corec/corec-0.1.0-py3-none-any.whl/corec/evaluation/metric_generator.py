...
try:
    ...
    raise ImportError(
        "El módulo 'recomendador' requiere la librería 'elliot'. "
        "Instálala usando: pip install corec[recommender]"
    ) from e

from ..recommenders.heuristic_recommenders.context_satisfaction import (
