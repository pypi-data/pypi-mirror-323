...
class LlamaCppBackend:
    ...
    def completion(self, request_tokens, temp=0.7, top_p=0.9, min_p=0.1, top_k=0, dry_multiplier=0.8):
    ...
    async def async_completion(self, request_tokens, temp=0.7, top_p=0.9, min_p=0.1, top_k=0, dry_multiplier=0.8, callback=None):
