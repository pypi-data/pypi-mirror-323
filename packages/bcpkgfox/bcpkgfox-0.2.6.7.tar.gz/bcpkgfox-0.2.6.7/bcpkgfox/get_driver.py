...
def backcode__dont_use__launch_browser(download_dir: str, extension_path: Optional[str] = None) -> WebElement:
    """ Caso queria adicionar a extensão, coloque somente o NOME dela na variavel 'extension_path' mas tem que ser PASTA, não arquivo .CRX """
