...
be at least 10x smaller than your review limit. '''
    ...
    def deck_config_percent_of_reviews(self, reviews: int, pct: str) -> str:
        ...
        return self._translate(11, 140, {"reviews": reviews, "pct": pct})
    ...
    def deck_config_predicted_minimum_recommended_retention(self, num: FluentVariable) -> str:
        ...
        return self._translate(11, 142, {"num": num})
...
sort orders preferable. '''
    ...
    def deck_config_reviews_too_low(self, cards: int, expected: FluentVariable) -> str:
        ...
        return self._translate(11, 163, {"cards": cards, "expected": expected})
...
- `Today only`: Make a temporary change to this deck's limit. '''
    ...
    def deck_config_updating_cards(self, current_cards_count: int, total_cards_count: int) -> str:
        ...
        return self._translate(11, 205, {"current_cards_count": current_cards_count, "total_cards_count": total_cards_count})


    def deck_config_used_by_decks(self, decks: int) -> str:
        r''' used by {$decks} decks '''
        return self._translate(11, 206, {"decks": decks})
...
class LegacyTranslationEnum:
    ...
    DECK_CONFIG_PERCENT_OF_REVIEWS = (11, 140)
    DECK_CONFIG_PLEASE_SAVE_YOUR_CHANGES_FIRST = (11, 141)
    DECK_CONFIG_PREDICTED_MINIMUM_RECOMMENDED_RETENTION = (11, 142)
    DECK_CONFIG_PREDICTED_OPTIMAL_RETENTION = (11, 143)
    DECK_CONFIG_QUESTION_ACTION = (11, 144)
    DECK_CONFIG_QUESTION_ACTION_SHOW_ANSWER = (11, 145)
    DECK_CONFIG_QUESTION_ACTION_SHOW_REMINDER = (11, 146)
    DECK_CONFIG_QUESTION_ACTION_TOOL_TIP = (11, 147)
    DECK_CONFIG_RELEARNING_STEPS = (11, 148)
    DECK_CONFIG_RELEARNING_STEPS_ABOVE_MINIMUM_INTERVAL = (11, 149)
    DECK_CONFIG_RELEARNING_STEPS_TOOLTIP = (11, 150)
    DECK_CONFIG_REMOVE_GROUP = (11, 151)
    DECK_CONFIG_RENAME_GROUP = (11, 152)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE = (11, 153)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE_TOOLTIP = (11, 154)
    DECK_CONFIG_RESCHEDULE_CARDS_WARNING = (11, 155)
    DECK_CONFIG_REVERT_BUTTON_TOOLTIP = (11, 156)
    DECK_CONFIG_REVIEW_LIMIT_TOOLTIP = (11, 157)
    DECK_CONFIG_REVIEW_MIX_MIX_WITH_REVIEWS = (11, 158)
    DECK_CONFIG_REVIEW_MIX_SHOW_AFTER_REVIEWS = (11, 159)
    DECK_CONFIG_REVIEW_MIX_SHOW_BEFORE_REVIEWS = (11, 160)
    DECK_CONFIG_REVIEW_SORT_ORDER = (11, 161)
    DECK_CONFIG_REVIEW_SORT_ORDER_TOOLTIP = (11, 162)
    DECK_CONFIG_REVIEWS_TOO_LOW = (11, 163)
    DECK_CONFIG_SAVE_AND_OPTIMIZE = (11, 164)
    DECK_CONFIG_SAVE_BUTTON = (11, 165)
    DECK_CONFIG_SAVE_TO_ALL_SUBDECKS = (11, 166)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER = (11, 167)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER_TOOLTIP_2 = (11, 168)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION = (11, 169)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP = (11, 170)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP_2 = (11, 171)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP_3 = (11, 172)
    DECK_CONFIG_SHARED_PRESET = (11, 173)
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (11, 174)
    DECK_CONFIG_SHOW_REMINDER = (11, 175)
    DECK_CONFIG_SIMULATE = (11, 176)
    DECK_CONFIG_SKIP_QUESTION_WHEN_REPLAYING = (11, 177)
    DECK_CONFIG_SMALLER_IS_BETTER = (11, 178)
    DECK_CONFIG_SORT_ORDER_ASCENDING_DIFFICULTY = (11, 179)
    DECK_CONFIG_SORT_ORDER_ASCENDING_EASE = (11, 180)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (11, 181)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (11, 182)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (11, 183)
    DECK_CONFIG_SORT_ORDER_DESCENDING_DIFFICULTY = (11, 184)
    DECK_CONFIG_SORT_ORDER_DESCENDING_EASE = (11, 185)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (11, 186)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (11, 187)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (11, 188)
    DECK_CONFIG_SORT_ORDER_GATHER = (11, 189)
    DECK_CONFIG_SORT_ORDER_RANDOM = (11, 190)
    DECK_CONFIG_SORT_ORDER_RANDOM_NOTE_THEN_TEMPLATE = (11, 191)
    DECK_CONFIG_SORT_ORDER_RETRIEVABILITY_ASCENDING = (11, 192)
    DECK_CONFIG_SORT_ORDER_RETRIEVABILITY_DESCENDING = (11, 193)
    DECK_CONFIG_SORT_ORDER_TEMPLATE_THEN_GATHER = (11, 194)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (11, 195)
    DECK_CONFIG_STEPS_TOO_LARGE_FOR_FSRS = (11, 196)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER = (11, 197)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER_TOOLTIP = (11, 198)
    DECK_CONFIG_TAB_DESCRIPTION = (11, 199)
    DECK_CONFIG_TIME_TO_OPTIMIZE = (11, 200)
    DECK_CONFIG_TIMER_TITLE = (11, 201)
    DECK_CONFIG_TITLE = (11, 202)
    DECK_CONFIG_TODAY_ONLY = (11, 203)
    DECK_CONFIG_UNABLE_TO_DETERMINE_DESIRED_RETENTION = (11, 204)
    DECK_CONFIG_UPDATING_CARDS = (11, 205)
    DECK_CONFIG_USED_BY_DECKS = (11, 206)
    DECK_CONFIG_WAIT_FOR_AUDIO = (11, 207)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP = (11, 208)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP_2 = (11, 209)
    DECK_CONFIG_WEIGHTS = (11, 210)
    DECK_CONFIG_WEIGHTS_TOOLTIP = (11, 211)
    DECK_CONFIG_WEIGHTS_TOOLTIP2 = (11, 212)
    DECK_CONFIG_WHICH_DECK = (11, 213)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (11, 214)
