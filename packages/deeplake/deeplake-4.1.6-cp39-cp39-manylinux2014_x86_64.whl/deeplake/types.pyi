...
class EmbeddingIndexType:
    ...
    """
    Clustered: typing.ClassVar[EmbeddingIndexType]  # value = <EmbeddingIndexType.Clustered: 0>
    ClusteredQuantized: typing.ClassVar[EmbeddingIndexType]  # value = <EmbeddingIndexType.ClusteredQuantized: 1>
    __members__: typing.ClassVar[dict[str, EmbeddingIndexType]]  # value = {'Clustered': <EmbeddingIndexType.Clustered: 0>, 'ClusteredQuantized': <EmbeddingIndexType.ClusteredQuantized: 1>}
...
class IndexType:
    """
    Enumeration of all available index types in the deeplake.
    """
    __hash__: typing.ClassVar[None] = None
    def __eq__(self, other: IndexType) -> bool:
        ...
    def __init__(self, index_type: TextIndexType | EmbeddingIndexType) -> None:
        ...
...
def Embedding(
    ...
    Examples:
        ...
        ds.add_column("col2", types.Embedding(768, index_type=types.EmbeddingIndexType.ClusteredQuantized))
        ```
    """
    ...
