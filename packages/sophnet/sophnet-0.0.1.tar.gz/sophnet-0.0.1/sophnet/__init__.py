...
from ._client import Client, SophNet, Stream, Timeout, Transport, AsyncClient, AsyncOpenAI, AsyncStream, RequestOptions
...
class _AmbiguousModuleClientUsageError(SophNetError):
...
_client: SophNet | None = None


def _load_client() -> SophNet:  # type: ignore[reportUnusedFunction]
    global _client
