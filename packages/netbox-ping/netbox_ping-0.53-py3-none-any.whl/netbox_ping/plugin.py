    ...
    custom_links_data = [
        {
            'name': 'Ping IP',
            'link_text': 'Ping',
            'link_url': 'plugins/netbox-ping/ping-ip/{{ object.address }}/',  # Simple relative path
            'weight': 100,
        ...
        },
        {
            ...
            'link_url': 'plugins/netbox-ping/scan-prefix/{{ object.prefix }}/?action=ping',  # Simple relative path
            'weight': 100,
        ...
        },
        {
            ...
            'link_url': 'plugins/netbox-ping/scan-prefix/{{ object.prefix }}/?action=scan',  # Simple relative path
            'weight': 200,
            'object_types': [prefix_type]
        }
    ]
