    ...
    custom_links_data = [
        {
            'name': 'Ping IP',
            'link_text': 'Ping',
            'link_url': '{% url "plugins:netbox_ping:ping_ip" object.address %}',  # Use URL namespacing
            'weight': 100,
        ...
        },
        {
            ...
            'link_url': '{% url "plugins:netbox_ping:scan_prefix" object.prefix %}?action=ping',  # Use URL namespacing
            'weight': 100,
        ...
        },
        {
            ...
            'link_url': '{% url "plugins:netbox_ping:scan_prefix" object.prefix %}?action=scan',  # Use URL namespacing
            'weight': 200,
            'object_types': [prefix_type]
        }
    ]
