    ...
    custom_links_data = [
        {
            'name': 'Ping IP',
            'link_text': 'Ping',
            'link_url': '{{ settings.BASE_PATH }}/plugins/netbox-ping/ping-ip/{{ object.address }}/',
            'weight': 100,
        ...
        },
        {
            ...
            'link_url': '{{ settings.BASE_PATH }}/plugins/netbox-ping/scan-prefix/{{ object.prefix }}/?action=ping',
            'weight': 100,
        ...
        },
        {
            ...
            'link_url': '{{ settings.BASE_PATH }}/plugins/netbox-ping/scan-prefix/{{ object.prefix }}/?action=scan',
            'weight': 200,
            'object_types': [prefix_type]
        }
    ]
