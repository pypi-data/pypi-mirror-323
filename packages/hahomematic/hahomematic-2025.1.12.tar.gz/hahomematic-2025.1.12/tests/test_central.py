...
async def test_add_device(
    ...
    assert len(central.get_data_points(exclude_no_create=False)) == 29
    ...
    assert len(central.get_data_points(exclude_no_create=False)) == 60
