...
struct PlotTaskSettings {
  ...
  REFLECTABLE((std::vector<double>)p1, (std::vector<double>)p2, (std::vector<double>)p3, (std::vector<double>)p4,
              ...
              (std::vector<unsigned int>)orbitals, (double)maxGridPoints, (bool)cavity, (bool)gridCoordinates, (bool)ntos,
              (double)ntoPlotThreshold, (std::vector<unsigned int>)excitations, (bool)nros, (double)nrominimum)
};
