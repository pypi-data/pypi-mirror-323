...
from klat_connector.utils.sio_connection_utils import SocketIOCompat
...
class KlatApi(KlatApiABC):
    ...
    def __init__(self, socket, dom="klattalk.com", init_nick=None):
        ...
        if not self.klat_ready.wait(30):
            ...
            raise KlatAPIError(f"Klat server connection to "
                               f"{self.socket.connection_url} not established!")
