...
if __name__ == "__main__":
    ...
    parser.add_argument('subcmd',help = 'subcmd') 
    ...
    if False:
        ...
        parser.add_argument('--auth-name', nargs = None, type = str, default='dknova', help = 'auth-name')
        parser.add_argument('--auth-pwd', nargs = None, type = str, default='123456', help = 'auth-pwd')
