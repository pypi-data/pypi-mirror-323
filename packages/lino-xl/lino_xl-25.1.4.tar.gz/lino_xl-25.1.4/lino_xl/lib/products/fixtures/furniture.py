...
def objects():
    ...
    def product(price, cat, **kwargs):
        ...
        return rt.models.products.Product(sales_price=price,
                                          category=cat,
                                          **kwargs)
...
Produit de l'année 2008.""",
    ...
    yield product(
        ...
        **dd.babel_values(
            'name',
            _("Server software installation, configuration and administration"
              ),
            et=
    ...
    yield product(
        ...
        **dd.babel_values(
            'name',
            _("Image processing and website content maintenance"),
