...
def parse_and_validate_date_data(
    ...
    post_period = tuple(
        [_convert_date_to_index_type(p, data) for p in post_intervention_period])
    pre_intervention_period, post_period = _parse_and_validate_periods(pre_intervention_period,
                                                                       post_intervention_period,
                                                                       data)
    return pre_intervention_period, post_intervention_period
