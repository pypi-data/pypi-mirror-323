...
class MeteorologicalStationStats(GeoModel):
    ...
    insolation_max_ts: Optional[Datetime] = Field(
        None,
        description="TBD",
    )
    ...
    insolation_min_ts: Optional[Datetime] = Field(
        None,
        description="TBD",
    )
    ...
    pressure_max_ts: Optional[Datetime] = Field(
        None,
        description="TBD",
    )
    ...
    pressure_min_ts: Optional[Datetime] = Field(
        None,
        description="TBD",
    )
