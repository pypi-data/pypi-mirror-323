    ...
    def _prepare_margin_params(self, exchange_id: str, order: OrderConfig, base_params: Dict) -> Dict:
        ...
        if order.margin_mode:
            if exchange_id == 'binance':
                params['type'] = 'margin'  # Use margin endpoint
                params['marginMode'] = 'cross'  # Default to cross margin
            elif exchange_id == 'bybit':
                params['isLeverage'] = True  # Enable margin trading
            elif exchange_id == 'okx':
                params['tdMode'] = 'cross'  # Default to cross margin
