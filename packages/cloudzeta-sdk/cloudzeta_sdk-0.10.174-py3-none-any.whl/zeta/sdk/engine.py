...
class ZetaEngine(object):
    ...
    def _refresh_supabase_auth_token(self) -> bool:
        ...
        # It is not necessary to write the new refresh token back to the database, as refresh
        # tokens should be evergreen.
        #
        # res_update = self._maybe_update_refresh_token(response.session.refresh_token)
