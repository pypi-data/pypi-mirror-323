...
class ILController_RSST_AG:
    ...
    def __write_ilc_values_to_store_setup(self):
        ...
        self.__write_ilc_values_to_store_setup("S_tol",self.S_tol)
        self.__write_ilc_values_to_store_setup("B_tol",self.B_tol)
        self.__write_ilc_values_to_store_setup("FF_tol",self.FF_tol)
