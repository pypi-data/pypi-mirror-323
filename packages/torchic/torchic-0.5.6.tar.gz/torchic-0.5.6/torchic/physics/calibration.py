...
def cluster_size_calibration(h2: TH2F, output_file: TDirectory, fitter: Roofitter, charge: float = 1., fit_charge: bool = False, fit_mc: bool = False, **kwargs) -> dict:
    '''
    ...
    if fit_charge:
        ...
        simil_bethe_bloch_func.FixParameter(3, 1.)
