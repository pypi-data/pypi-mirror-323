...
def Timeline(phase, exptime, filter, noisetimeline, nreadoutscale, timelinestep, wmap, seed, peakprominence):
    ...
    for t in range(exptime):
        ntime = rng.normal(loc = 0, scale = nreadoutscale, size = int(timelinestep))
