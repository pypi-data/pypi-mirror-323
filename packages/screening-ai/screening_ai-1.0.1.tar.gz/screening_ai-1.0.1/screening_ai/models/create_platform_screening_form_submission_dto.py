...
class CreatePlatformScreeningFormSubmissionDto(BaseModel):
    """
    ...
    chat: List[StrictStr] = Field(description="Chat")
    ...
    __properties: ClassVar[List[str]] = ["orgId", "orgAlias", "email", "firstName", "lastName", "phoneNumber", "screeningJobId", "chat", "createdAt", "status", "upvotes", "isViewed", "isPrivate"]
