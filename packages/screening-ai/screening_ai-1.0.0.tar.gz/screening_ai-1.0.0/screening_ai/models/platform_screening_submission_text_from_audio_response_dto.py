...
class PlatformScreeningSubmissionTextFromAudioResponseDto(BaseModel):
    """
    PlatformScreeningSubmissionTextFromAudioResponseDto
    """ # noqa: E501
    data: StrictStr = Field(description="Text from Audio")
    answer_location: StrictStr = Field(description="Audio Url", alias="answerLocation")
    __properties: ClassVar[List[str]] = ["data", "answerLocation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": obj.get("data"),
            "answerLocation": obj.get("answerLocation")
        })
        return _obj
