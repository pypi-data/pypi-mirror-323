...
class PlatformScreeningSubmissionCreateStreamRoomResponseDto(BaseModel):
    """
    PlatformScreeningSubmissionCreateStreamRoomResponseDto
    """ # noqa: E501
    access_token: StrictStr = Field(description="Token", alias="accessToken")
    url: StrictStr = Field(description="Url")
    __properties: ClassVar[List[str]] = ["accessToken", "url"]
