...
class GenerateScreeningTemplateQuestionsDto(BaseModel):
    """
    GenerateScreeningTemplateQuestionsDto
    """ # noqa: E501
    job_title: StrictStr = Field(description="Task Title", alias="jobTitle")
    __properties: ClassVar[List[str]] = ["jobTitle"]
