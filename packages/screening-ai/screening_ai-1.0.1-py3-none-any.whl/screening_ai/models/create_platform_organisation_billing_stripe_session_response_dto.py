...
class CreatePlatformOrganisationBillingStripeSessionResponseDto(BaseModel):
    """
    CreatePlatformOrganisationBillingStripeSessionResponseDto
    """ # noqa: E501
    message: StrictStr = Field(description="Message")
    stripe_payment_session_id: StrictStr = Field(description="Stripe Payment Session ID", alias="stripePaymentSessionId")
    __properties: ClassVar[List[str]] = ["message", "stripePaymentSessionId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stripePaymentSessionId": obj.get("stripePaymentSessionId")
        })
        return _obj
