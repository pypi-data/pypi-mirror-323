...
class CreatePlatformScreeningSubmissionStreamingRoomTokenDto(BaseModel):
    """
    ...
    curr_date_time_epoch: Union[StrictFloat, StrictInt] = Field(description="Current Date Time in Epoch", alias="currDateTimeEpoch")
    __properties: ClassVar[List[str]] = ["screeningJobId", "screeningSubmissionId", "currDateTimeEpoch"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "currDateTimeEpoch": obj.get("currDateTimeEpoch")
        })
        return _obj
