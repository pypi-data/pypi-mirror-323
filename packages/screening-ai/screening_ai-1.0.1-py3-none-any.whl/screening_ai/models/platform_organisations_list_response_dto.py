...
class PlatformOrganisationsListResponseDto(BaseModel):
    """
    PlatformOrganisationsListResponseDto
    """ # noqa: E501
    organisations: List[StrictStr] = Field(description="List of Organisations")
    __properties: ClassVar[List[str]] = ["organisations"]
