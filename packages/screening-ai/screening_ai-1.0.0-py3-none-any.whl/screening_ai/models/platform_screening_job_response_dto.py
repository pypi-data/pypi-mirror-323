...
class PlatformScreeningJobResponseDto(BaseModel):
    """
    ...
    upvotes: List[StrictStr] = Field(description="Upvoted By")
    created_at: StrictStr = Field(description="Creation date in ISO Date Time String", alias="createdAt")
    __properties: ClassVar[List[str]] = ["screeningJobId", "orgId", "orgAlias", "screeningTemplateId", "title", "jobActive", "jd", "upvotes", "createdAt"]
