...
class GetPlatformScreeningSubmissionsOfOrgDto(BaseModel):
    """
    ...
    start_after: StrictStr = Field(description="Start After", alias="startAfter")
    limit: Union[StrictFloat, StrictInt] = Field(description="Limit")
    __properties: ClassVar[List[str]] = ["orgAlias", "jobId", "status", "startAfter", "limit"]
