...
class ApiResponseWrapper(BaseModel):
    ...
    description: StrictStr = Field(description="Description of the response")
    data: ApiResponseWrapperData
    __properties: ClassVar[List[str]] = ["status", "description", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ApiResponseWrapperData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
