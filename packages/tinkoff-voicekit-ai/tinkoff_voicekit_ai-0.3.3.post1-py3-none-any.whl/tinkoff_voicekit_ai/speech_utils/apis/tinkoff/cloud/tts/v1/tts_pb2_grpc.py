...
from tinkoff_voicekit_ai.speech_utils.apis.tinkoff.cloud.tts.v1 import tts_pb2 as tinkoff_dot_cloud_dot_tts_dot_v1_dot_tts__pb2
...
class TextToSpeechServicer(object):
    ...
    def ListVoices(self, request, context):
        """Метод для получения списка доступных голосов.
        """
