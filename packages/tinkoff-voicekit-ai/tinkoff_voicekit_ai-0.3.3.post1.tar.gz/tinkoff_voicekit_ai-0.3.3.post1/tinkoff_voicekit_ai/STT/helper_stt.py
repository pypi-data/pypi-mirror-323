...
from tinkoff_voicekit_ai.speech_utils.apis.tinkoff.cloud.stt.v1 import stt_pb2
from tinkoff_voicekit_ai.speech_utils.config_data import MAX_LENGTH, CHUNK_SIZE
