...
class Logger:
    ...
    def set_progress(self, remaining_time_seconds: Optional[int] = None):
        """
        Set the current progress of the automation.
        
        The progress percentage is automatically calculated based on:
        - Elapsed time
        ...
        Args:
            remaining_time_seconds (int, optional): 
                ...
                progress will be estimated based on elapsed time.
    ...
    def info(self, message: str, severity: int = 1, component: Optional[str] = None,
        ...
        Args:
            ...
            progress (dict or int/float, optional): Progress information. Can be:
                - A dictionary with 'progress_percentage' and/or 'remaining_time_seconds'
                - A direct percentage value (0-100)
        ...
        Example:
            ...
            logger.info(
                ...
                progress={"progress_percentage": 45, "remaining_time_seconds": 300}
            )

            # With direct progress percentage
            logger.info("Halfway done", progress=50)
            ```
        """
    ...
    def alert(self, message: str, severity: int = 3, component: Optional[str] = None,
        ...
        Args:
            ...
            progress (dict or int/float, optional): Progress information.
