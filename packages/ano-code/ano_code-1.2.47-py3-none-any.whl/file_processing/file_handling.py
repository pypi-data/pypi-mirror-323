...
def run_req(base_folder_path: str, api_url: str, repo_id: str):
    ...
    for folder_name in os.listdir(base_folder_path):
        ...
        if folder_name in {".yarn", ".git", ".vscode", ".pytest_cache", "__pycache__", "node_modules", "auto-code-env", "dist", "venv", ".github", "ano_code",".egg-info auto-code-env", ".git", ".vscode", "auto_code.egg-info"}:
            continue
