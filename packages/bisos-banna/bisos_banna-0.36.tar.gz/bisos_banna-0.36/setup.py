...
####+BEGINNOT: b:py3:pypi:setup/pkgName :comment "Auto Detected"
...
# ./pypiUploadVer EXISTED -- forPypiVersion=0.36 -- forSysVersion=0.3 -- constant=NA
def pkgVersion():
        return '0.36'
