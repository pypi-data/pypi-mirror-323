from softwareai.CoreApp.SoftwareAI.Functions_Submit_Outputs.ControlSupport.CalculateAverageCSAT import submit_output_CalculateAverageCSAT
...
def _init_output_(function_name,
    ...
    functions_to_call = [
        submit_output_CalculateAverageCSAT,
