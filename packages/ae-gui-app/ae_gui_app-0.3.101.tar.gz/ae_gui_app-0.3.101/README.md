...
[![LatestPyPIrelease](
    https://img.shields.io/gitlab/pipeline/ae-group/ae_gui_app/release0.3.100?logo=python)](
    https://gitlab.com/ae-group/ae_gui_app/-/tree/release0.3.100)
[![PyPIVersions](https://img.shields.io/pypi/v/ae_gui_app)](
    https://pypi.org/project/ae-gui-app/#history)

>ae_gui_app package 0.3.101.
