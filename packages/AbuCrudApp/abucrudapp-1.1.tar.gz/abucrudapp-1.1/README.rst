...
**AbuCrudApp** is a Flask-based Python framework that simplifies the development of MySQL-powered web applications. It provides a streamlined interface for connecting to a MySQL database, rendering templates, and executing queries dynamically via RESTful APIs.
...
.. image:: https://badge.fury.io/py/AbuCrudApp.svg
    :target: https://pypi.org/project/AbuCrudApp/
...
.. code-block:: python
    ...
    from AbuCrudApp.MysqlApplication import MysqlApplication
