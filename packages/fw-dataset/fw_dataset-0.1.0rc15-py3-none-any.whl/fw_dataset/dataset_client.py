...
from .filesystem_fns import _get_storage_credentials, get_storage_filesystem
...
class FWDatasetClient:
    ...
    def get_dataset(
        ...
        credentials = _get_storage_credentials(
            self.api_client, dataset_info.get("type"), dataset_info.get("storage_id")
        )

        filesystem = get_storage_filesystem(dataset_info.get("type"), credentials)
