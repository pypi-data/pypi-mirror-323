...
def get_connections(connection_id: Optional[str] = None,
    ...
    :param str connection_id: Limit connections to a specific connection ID
...
def get_connections_output(connection_id: Optional[pulumi.Input[Optional[str]]] = None,
