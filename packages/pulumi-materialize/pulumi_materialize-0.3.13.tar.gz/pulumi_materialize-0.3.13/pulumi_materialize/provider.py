...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] host: The Materialize host. Can also come from the `MZ_HOST` environment variable.
        :param pulumi.Input[str] password: Materialize host. Can also come from the `MZ_PASSWORD` environment variable.
        :param pulumi.Input[int] port: The Materialize SQL port. Can also come from the `MZ_PORT` environment variable.
        :param pulumi.Input[str] sslmode: For testing purposes, the SSL mode to use.
        :param pulumi.Input[str] username: The Materialize username. Can also come from the `MZ_USERNAME` environment variable.
        """
