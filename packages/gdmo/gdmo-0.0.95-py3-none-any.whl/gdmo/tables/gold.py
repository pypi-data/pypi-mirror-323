    ...
    def set_final(self, reloaded = 0):
        ...
        if self._config['loadType'] == 'append':
            ...
            try:
                ...
                print(f"Number of affected records: {merge_builder.collect()[0]['num_affected_rows']}")
                print(f"Number of inserted records: {merge_builder.collect()[0]['num_inserted_rows']}")
                print(f"Number of updated records: {merge_builder.collect()[0]['num_updated_rows']}")
                #display(stage)
