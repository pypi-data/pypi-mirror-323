...
from typing import Any, Optional, Dict, Union, TypeVar, Generic, TypedDict, BinaryIO, Iterator, Tuple
...
class MultipartData:
    ...
    def _parse(self) -> None:
        ...
        body_bytes = base64.b64decode(self.body) if ';base64,' in self.body else self.body.encode()
        ...
        for headers, content in parser.parse():
            ...
            params = dict(param.strip().split('=', 1) for param in disposition.split(';')[1:])
