...
c_sources = [
    ...
    os.path.join('xmss-reference', 'xmssmt_wrapper.c'),
    os.path.join('xmss-reference', 'xmssmt.pxd'),
    os.path.join('xmss-reference', 'xmssmt_wrapper.pyx'),
...
setup(
    ...
    package_data={"xmssmt_wrapper": [os.path.join('xmss-reference', 'xmssmt_wrapper.pyx'), os.path.join('xmss-reference', 'xmssmt.pxd'),]},
)