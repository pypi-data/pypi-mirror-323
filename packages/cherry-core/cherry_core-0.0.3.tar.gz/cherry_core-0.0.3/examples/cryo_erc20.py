...
# cast large_binary columns to regular binary, now sure why all binary columns end up being large_binary
...
# the named column 'amount' to type 'Float64' in this case.
decoded = cherry_core.cast([("amount", "Float64")], decoded, allow_cast_fail=False)
