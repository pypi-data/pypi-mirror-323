...
from earnix_elevate.clients.admin.api_client import ApiClient, RequestSerialized
...
from earnix_elevate.clients.admin.rest import RESTResponseType


class TenantsServiceApi:
