...
class Trademarks(FetchStepHttpAuth):
    ...
    def parse_links(self, archive_name, count, cmd=None, archive_path=None,
        ...
        os.rename(os.path.join(self.output_dir, archive_name), archive_dest_with_index)

        self.logger.info('>> renaming: %s to %s' % (os.path.join(self.output_dir, archive_name), archive_dest_with_index))
