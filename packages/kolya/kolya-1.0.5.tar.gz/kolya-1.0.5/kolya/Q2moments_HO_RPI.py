...
def Xx8(i,Q2,r,dQ2,dr):
    ...
    # tree level function
    if (dQ2 == 0 and dr == 0 and i==0):
        return     ((4*(3*(-1+Q2)+(4+26*Q2+Q2**3*(-7+Q2*(7+9*Q2)))*r**2-(-8+Q2*(41
        +Q2*(44+Q2*(58+27*Q2))))*r**4+(-33+Q2*(37+6*Q2*(10+3*Q2)))*r**6
        +2*(25+Q2*(13+9*Q2))*r**8-(35+27*Q2)*r**10+9*r**12+12*logu*r**2*sqrtQ2))/(9*r**2*sqrtQ2))
    if (dQ2 == 0 and dr == 0 and i==1):
        return    ((2*(30*(-1+Q2)+3*(-181+Q2*(391+Q2*(-55+Q2*(-5+4*Q2*(-5+4*Q2
        +6*Q2**2)))))*r**2-(-593+Q2*(-2686+Q2*(414+Q2*(299+Q2*(409+207*Q2)))))*r**4
        +(865+Q2*(281+Q2*(293+Q2*(406+135*Q2))))*r**6+(-1320+Q2*(-169
        +18*Q2*(2+5*Q2)))*r**8+(595+2*(53-45*Q2)*Q2)*r**10-(187+27*Q2)*r**12
        +27*r**14+540*logu*r**2*sqrtQ2+1500*logu*r**4*sqrtQ2))/(45*r**2*sqrtQ2))
    if (dQ2 == 0 and dr == 0 and i==2):
        return     (((20*(-1+Q2)+2*(-513+Q2*(903+Q2*(-160+Q2*(3+2*Q2)*(-10+Q2*(5
        +Q2*(-9+10*Q2))))))*r**2-2*(723+Q2*(-4712+Q2*(634+Q2*(114+Q2*(79
        +2*Q2*(53+28*Q2))))))*r**4+4*(1203+Q2*(2639+Q2*(-95+Q2*(29+3*Q2*(17
        +6*Q2)))))*r**6+4*(-195+2*Q2*(117+Q2*(13+Q2*(3+5*Q2))))*r**8-2*(955
        +Q2*(117+4*Q2*(2+5*Q2)))*r**10+2*(223+30*Q2)*r**12-4*(21+2*Q2)*r**14
        +8*r**16+720*logu*r**2*sqrtQ2+4800*logu*r**4*sqrtQ2+5760*logu*r**6*sqrtQ2))/(15*r**2*sqrtQ2))
    if (dQ2 == 0 and dr == 0 and i==3):
        return     (((420*(-1+Q2)+(-41161+Q2*(66781+Q2*(-11340+Q2*(-3220+Q2*(-875
        +Q2*(-189+8*Q2*(-77+10*Q2*(5+9*Q2))))))))*r**2-(187676+Q2*(-592979
        +Q2*(90718+Q2*(15258+Q2*(4058+Q2*(2777+44*Q2*(83+45*Q2)))))))*r**4
        +(127197+Q2*(1375376+Q2*(-132840+Q2*(-7254+Q2*(1609+12*Q2*(286
        +105*Q2))))))*r**6+2*(209755+Q2*(432993+Q2*(-6063+Q2*(692+45*Q2*(5
        +7*Q2)))))*r**8+(-253505+Q2*(47791-2*Q2*(-962+45*Q2*(2+7*Q2))))*r**10
        -(73164+5*Q2*(1387+36*Q2))*r**12+(10451+1052*Q2)*r**14-2*(661+45*Q2)*r**16
        +90*r**18+24360*logu*r**2*sqrtQ2+279720*logu*r**4*sqrtQ2+730800*logu*r**6*sqrtQ2
        +436800*logu*r**8*sqrtQ2))/(315*r**2*sqrtQ2))
    if (dQ2 == 0 and dr == 0 and i==4):
        return     (((420*(-1+Q2)+6*(-11103+Q2*(17193+Q2*(-2800+Q2*(-840+Q2*(-350
        +Q2*(-112+Q2*(-28+5*Q2*(-18+Q2*(11+21*Q2)))))))))*r**2-2*(281839
        +Q2*(-686896+Q2*(110202+Q2*(22282+Q2*(5552+Q2*(1758+Q2*(1198
        +5*Q2*(310+171*Q2))))))))*r**4+4*(-128971+Q2*(1290937+Q2*(-160535
        +Q2*(-18258+Q2*(-1642+Q2*(284+5*Q2*(143+54*Q2)))))))*r**6+4*(428001
        +Q2*(1655476+Q2*(-108402+Q2*(-2832+Q2*(230+9*Q2*(11+14*Q2))))))*r**8
        -4*(-153454+Q2*(-645180+Q2*(3954+Q2*(-338+9*Q2*(3+14*Q2)))))*r**10
        +4*(-267358+Q2*(22628+(419-27*Q2)*Q2))*r**12-4*(30093+Q2*(2173
        +27*Q2))*r**14+4*(2896+223*Q2)*r**16-2*(527+27*Q2)*r**18+54*r**20
        +35280*logu*r**2*sqrtQ2+608160*logu*r**4*sqrtQ2+2620800*logu*r**6*sqrtQ2
        +3497760*logu*r**8*sqrtQ2+1201200*logu*r**10*sqrtQ2))/(315*r**2*sqrtQ2))
...
def Xx10(i,Q2,r,dQ2,dr):
    ...
    # tree level function
    if (dQ2 == 0 and dr == 0 and i==0):
        return     (((3-9*Q2+9*Q2**2-3*Q2**3+14*r**2-135*Q2*r**2+219*Q2**2*r**2-124*Q2**3*r**2
        +24*Q2**4*r**2+6*Q2**5*r**2+5*Q2**6*r**2-9*Q2**7*r**2-96*r**4+315*Q2*r**4
        +111*Q2**2*r**4-39*Q2**3*r**4+3*Q2**4*r**4+69*Q2**5*r**4+45*Q2**6*r**4+198*r**6
        -261*Q2*r**6-168*Q2**2*r**6-249*Q2**3*r**6-276*Q2**4*r**6-81*Q2**5*r**6
        -226*r**8+141*Q2*r**8+345*Q2**2*r**8+314*Q2**3*r**8+45*Q2**4*r**8+186*r**10
        +15*Q2*r**10-51*Q2**2*r**10+45*Q2**3*r**10-120*r**12-111*Q2*r**12-81*Q2**2*r**12
        +50*r**14+45*Q2*r**14-9*r**16-48*logu*r**2*((-1+Q2)**2-2*(1+Q2)*r**2
        +r**4)**(3/2)))/(9*r**2*((-1+Q2)**2-2*(1+Q2)*r**2+r**4)**(3/2)))
    if (dQ2 == 0 and dr == 0 and i==1):
        return    (((30-90*Q2+90*Q2**2-30*Q2**3+1403*r**2-5679*Q2*r**2+7479*Q2**2*r**2
        -3643*Q2**3*r**2+255*Q2**4*r**2+147*Q2**5*r**2+59*Q2**6*r**2+51*Q2**7*r**2
        -72*Q2**8*r**2-4954*r**4+825*Q2*r**4+14874*Q2**2*r**4-7495*Q2**3*r**4+60*Q2**4*r**4
        -51*Q2**5*r**4+470*Q2**6*r**4+351*Q2**7*r**4+4854*r**6+13869*Q2*r**6+10923*Q2**2*r**6
        -2682*Q2**3*r**6-1722*Q2**4*r**6-1911*Q2**5*r**6-621*Q2**6*r**6+1142*r**8
        -6435*Q2*r**8+4158*Q2**2*r**8+2648*Q2**3*r**8+2160*Q2**4*r**8+387*Q2**5*r**8
        -4840*r**10-3405*Q2*r**10-1227*Q2**2*r**10-715*Q2**3*r**10+135*Q2**4*r**10
        +3162*r**12+1299*Q2*r**12+174*Q2**2*r**12-243*Q2**3*r**12-1006*r**14-465*Q2*r**14
        +9*Q2**2*r**14+236*r**16+81*Q2*r**16-27*r**18-1200*logu*r**2*((-1+Q2)**2
        -2*(1+Q2)*r**2+r**4)**(3/2)-3360*logu*r**4*((-1+Q2)**2-2*(1+Q2)*r**2
        +r**4)**(3/2)))/(90*r**2*((-1+Q2)**2-2*(1+Q2)*r**2+r**4)**(3/2)))
    if (dQ2 == 0 and dr == 0 and i==2):
        return     (((30-90*Q2+90*Q2**2-30*Q2**3+2763*r**2-10359*Q2*r**2+13149*Q2**2*r**2
        -6213*Q2**3*r**2+465*Q2**4*r**2+57*Q2**5*r**2+99*Q2**6*r**2+51*Q2**7*r**2
        +48*Q2**8*r**2-60*Q2**9*r**2-2456*r**4-27189*Q2*r**4+63378*Q2**2*r**4-32633*Q2**3*r**4
        +2340*Q2**4*r**4+51*Q2**5*r**4-56*Q2**6*r**4+357*Q2**7*r**4+288*Q2**8*r**4
        -16150*r**6+39639*Q2*r**6+79317*Q2**2*r**6-32662*Q2**3*r**6-1092*Q2**4*r**6
        -1287*Q2**5*r**6-1471*Q2**6*r**6-504*Q2**7*r**6+32376*r**8+38829*Q2*r**8
        +57066*Q2**2*r**8-1644*Q2**3*r**8+1608*Q2**4*r**8+1611*Q2**5*r**8+324*Q2**6*r**8
        -17168*r**10-34365*Q2*r**10+7071*Q2**2*r**10+403*Q2**3*r**10-405*Q2**4*r**10
        +72*Q2**5*r**10-3388*r**12-7851*Q2*r**12-1458*Q2**2*r**12-253*Q2**3*r**12
        -180*Q2**4*r**12+4806*r**14+1689*Q2*r**14+303*Q2**2*r**14+72*Q2**3*r**14
        -950*r**16-339*Q2*r**16-36*Q2**2*r**16+149*r**18+36*Q2*r**18-12*r**20
        -1800*logu*r**2*((-1+Q2)**2-2*(1+Q2)*r**2+r**4)**(3/2)-12840*logu*r**4*((
        -1+Q2)**2-2*(1+Q2)*r**2+r**4)**(3/2)-12720*logu*r**6*((-1+Q2)**2-2*(1
        +Q2)*r**2+r**4)**(3/2)))/(90*r**2*((-1+Q2)**2-2*(1+Q2)*r**2+r**4)**(3/2)))
    if (dQ2 == 0 and dr == 0 and i==3):
        return     (((210-630*Q2+630*Q2**2-210*Q2**3+27941*r**2-101673*Q2*r**2+126243*Q2**2*r**2
        -57831*Q2**3*r**2+3675*Q2**4*r**2+819*Q2**5*r**2+63*Q2**6*r**2+507*Q2**7*r**2
        +306*Q2**8*r**2+310*Q2**9*r**2-360*Q2**10*r**2+74433*r**4-642558*Q2*r**4
        +1096821*Q2**2*r**4-550536*Q2**3*r**4+40215*Q2**4*r**4+6552*Q2**5*r**4+273*Q2**6*r**4
        -366*Q2**7*r**4+2016*Q2**8*r**4+1710*Q2**9*r**4-351465*r**6-140667*Q2*r**6
        +2464374*Q2**2*r**6-1201554*Q2**3*r**6+46581*Q2**4*r**6-6339*Q2**5*r**6-7242*Q2**6*r**6
        -8388*Q2**7*r**6-2970*Q2**8*r**6+125562*r**8+1582413*Q2*r**8+2492997*Q2**2*r**8
        -689093*Q2**3*r**8+5496*Q2**4*r**8+8907*Q2**5*r**8+9023*Q2**6*r**8+1935*Q2**7*r**8
        +529914*r**10+261345*Q2*r**10+1317732*Q2**2*r**10-31359*Q2**3*r**10-795*Q2**4*r**10
        -2226*Q2**5*r**10+315*Q2**6*r**10-532896*r**12-869337*Q2*r**12+92319*Q2**2*r**12
        +4434*Q2**3*r**12-735*Q2**4*r**12-945*Q2**5*r**12+81942*r**14-101157*Q2*r**14
        -12534*Q2**2*r**14-616*Q2**3*r**14+315*Q2**4*r**14+50340*r**16+13977*Q2*r**16
        +1713*Q2**2*r**16+45*Q2**3*r**16-6687*r**18-1848*Q2*r**18-135*Q2**2*r**18
        +751*r**20+135*Q2*r**20-45*r**22-15960*logu*r**2*((-1+Q2)**2-2*(1
        +Q2)*r**2+r**4)**(3/2)-196560*logu*r**4*((-1+Q2)**2-2*(1+Q2)*r**2+r**4)**(3/2)
        -478800*logu*r**6*((-1+Q2)**2-2*(1+Q2)*r**2+r**4)**(3/2)-256200*logu*r**8*((
        -1+Q2)**2-2*(1+Q2)*r**2+r**4)**(3/2)))/(630*r**2*((-1+Q2)**2-2*(1
        +Q2)*r**2+r**4)**(3/2)))
    if (dQ2 == 0 and dr == 0 and i==4):
        return     (((210-630*Q2+630*Q2**2-210*Q2**3+34823*r**2-124839*Q2*r**2+153189*Q2**2*r**2
        -69333*Q2**3*r**2+4620*Q2**4*r**2+672*Q2**5*r**2+294*Q2**6*r**2-54*Q2**7*r**2
        +393*Q2**8*r**2+265*Q2**9*r**2+285*Q2**10*r**2-315*Q2**11*r**2+233723*r**4
        -1306686*Q2*r**4+1986975*Q2**2*r**4-972672*Q2**3*r**4+68880*Q2**4*r**4+11592*Q2**5*r**4
        +3696*Q2**6*r**4+210*Q2**7*r**4-333*Q2**8*r**4+1690*Q2**9*r**4+1485*Q2**10*r**4
        -307155*r**6-2476557*Q2*r**6+7365090*Q2**2*r**6-3683454*Q2**3*r**6+209358*Q2**4*r**6
        +14478*Q2**5*r**6-5430*Q2**6*r**6-6072*Q2**7*r**6-7083*Q2**8*r**6-2565*Q2**9*r**6
        -1146105*r**8+2594952*Q2*r**8+11230290*Q2**2*r**8-4668368*Q2**3*r**8+135942*Q2**4*r**8
        +4236*Q2**5*r**8+7370*Q2**6*r**8+7530*Q2**7*r**8+1683*Q2**8*r**8+1802100*r**10
        +5320476*Q2*r**10+9251166*Q2**2*r**10-1779626*Q2**3*r**10+2202*Q2**4*r**10
        -582*Q2**5*r**10-1834*Q2**6*r**10+216*Q2**7*r**10+242844*r**12-1371552*Q2*r**12
        +3538326*Q2**2*r**12-53448*Q2**3*r**12-162*Q2**4*r**12-588*Q2**5*r**12-756*Q2**6*r**12
        -1358196*r**14-2483124*Q2*r**14+154890*Q2**2*r**14+5186*Q2**3*r**14+252*Q2**5*r**14
        +430530*r**16-166578*Q2*r**16-14700*Q2**2*r**16-502*Q2**3*r**16+73605*r**18
        +15963*Q2*r**18+1425*Q2**2*r**18+27*Q2**3*r**18-6935*r**20-1506*Q2*r**20
        -81*Q2**2*r**20+583*r**22+81*Q2*r**22-27*r**24-18480*logu*r**2*((-1+Q2)**2
        -2*(1+Q2)*r**2+r**4)**(3/2)-325920*logu*r**4*((-1+Q2)**2-2*(1+Q2)*r**2
        +r**4)**(3/2)-1401120*logu*r**6*((-1+Q2)**2-2*(1+Q2)*r**2+r**4)**(3/2)
        -1841280*logu*r**8*((-1+Q2)**2-2*(1+Q2)*r**2+r**4)**(3/2)-621600*logu*r**10*((
        -1+Q2)**2-2*(1+Q2)*r**2+r**4)**(3/2)))/(630*r**2*((-1+Q2)**2-2*(1
        +Q2)*r**2+r**4)**(3/2)))
