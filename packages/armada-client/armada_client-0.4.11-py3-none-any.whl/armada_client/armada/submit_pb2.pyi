...
class JobSubmitRequestItem(google.protobuf.message.Message):
    ...
    EXPERIMENTALPRICEINFO_FIELD_NUMBER: builtins.int
    ...
    @property
    def experimentalPriceInfo(self) -> global___ExperimentalPriceInfo: ...
    def __init__(
        self,
        *,
        priority: builtins.float = ...,
        ...
        scheduler: builtins.str = ...,
        experimentalPriceInfo: global___ExperimentalPriceInfo | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["experimentalPriceInfo", b"experimentalPriceInfo", "pod_spec", b"pod_spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["annotations", b"annotations", "client_id", b"client_id", "experimentalPriceInfo", b"experimentalPriceInfo", "ingress", b"ingress", "labels", b"labels", "namespace", b"namespace", "pod_spec", b"pod_spec", "pod_specs", b"pod_specs", "priority", b"priority", "required_node_labels", b"required_node_labels", "scheduler", b"scheduler", "services", b"services"]) -> None: ...
