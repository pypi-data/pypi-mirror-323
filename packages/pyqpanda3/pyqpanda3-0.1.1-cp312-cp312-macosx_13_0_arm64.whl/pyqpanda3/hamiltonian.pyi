...
class Hamiltonian:
    ...
    def tensor(self, n: int) -> Hamiltonian:
        ...
        *
        ...
        """
    def to_hamiltonian_pq2(self) -> list[tuple[dict[int, str], float]]:
        """to_hamiltonian_pq2(self: hamiltonian.Hamiltonian) -> list[tuple[dict[int, str], float]]"""
    @overload
...
class PauliOperator:
    ...
    def tensor(self, n: int) -> PauliOperator:
        ...
        """
    def to_hamiltonian_pq2(self) -> list[tuple[dict[int, str], float]]:
        """to_hamiltonian_pq2(self: hamiltonian.PauliOperator) -> list[tuple[dict[int, str], float]]"""
