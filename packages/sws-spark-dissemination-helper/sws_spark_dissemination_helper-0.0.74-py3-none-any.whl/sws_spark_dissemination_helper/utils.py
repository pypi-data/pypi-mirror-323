...
def map_codes(
    ...
    partition_columns = [
        col for col in dimension_columns if col.lower() != dest_column.lower()
    ] + ["partition_column"]
    
    logging.info("dimension columns:")
    logging.info(dimension_columns)
    logging.info("partition columns:")
    logging.info(partition_columns)
