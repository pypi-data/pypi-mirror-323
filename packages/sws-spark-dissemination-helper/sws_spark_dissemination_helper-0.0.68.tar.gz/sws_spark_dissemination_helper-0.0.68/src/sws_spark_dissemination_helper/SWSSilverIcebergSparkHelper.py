...
class SWSSilverIcebergSparkHelper:
    ...
    def _apply_code_correction_single(
        ...
        return map_codes(
            ...
            dimension_columns=[column for column in self.dim_columns_w_time if column not in self.flag_columns]
        )
    ...
    def remove_null_duplicates(self, df: DataFrame, partition_columns: List[str] = None) -> DataFrame:
        """
        ...
        window_spec = Window.partitionBy(*(partition_columns or self.dim_columns_w_time))
