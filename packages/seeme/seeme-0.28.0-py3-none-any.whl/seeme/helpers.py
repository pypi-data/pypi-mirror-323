...
def save_pickle(data_folder, filename, contents, mode="wb", extension=".pkl"):
...
def load_pickle(data_folder, filename, mode="rb", extension=".pkl"):
    filename = add_missing_extension(filename, extension)
    full_filename = f"{data_folder}/{filename}"
...
def save_anything(data_folder, filename, contents, mode="wb", protocol:Union["pkl", "dill"]="pkl", extension=".pkl"):
    if protocol == "pkl":
        save_pickle(data_folder, filename, contents, mode=mode, extension=extension)
...
def load_anything(data_folder, filename, mode="rb",protocol:Union["pkl", "dill"]="pkl", extension=".pkl"):
    if protocol == "pkl":
        return load_pickle(data_folder, filename, mode=mode, extension=extension)
