...
@app.post(
    ...
    response_model=RunIPythonCellResponse,
...
async def run_ipython_cell(request: RunIPythonCellRequest):
    ...
    try:
        if request.split_output:
            ...
            return RunIPythonCellResponse(output=output_buf.getvalue())
...
@app.post(
    ...
    response_model=RunShellCommandResponse,
