...
setup(
  ...
  version = '0.9.5.18',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/jhparkastro/gpcal/archive/v0.9.5.18.tar.gz',    # I explain this later on
