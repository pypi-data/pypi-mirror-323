...
class WrkActionDefinition(BaseModel):
    ...
    """ # noqa: E501
    user_defined_id: StrictStr = Field(description="A unique identifier for this Wrk Action within the Wrkflow", alias="userDefinedId")
    ...
    __properties: ClassVar[List[str]] = ["userDefinedId", "wrkActionRef", "inputValues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "userDefinedId": obj.get("userDefinedId"),
