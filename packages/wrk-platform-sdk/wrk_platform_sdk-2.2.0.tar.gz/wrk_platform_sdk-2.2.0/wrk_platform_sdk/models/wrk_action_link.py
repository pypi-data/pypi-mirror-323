...
class WrkActionLink(BaseModel):
    ...
    WrkActionLink
    """ # noqa: E501
    var_from: StrictStr = Field(description="The WrkActionId string from which this link originates", alias="from")
    to: StrictStr = Field(description="The WrkActionId string to which this link leads")
