"""Migrate Aibaba AI to the most recent version."""
...
def migrate(
    ...
    """Migrate aibaba_ai to the most recent version.

    Any undocumented arguments will be passed to the Grit CLI.
    """
    rich.print(
        "✈️ This script will help you migrate to a Aibaba AI 0.3. "
        "This migration script will attempt to replace old imports in the code "
        "with new ones. "
        "If you need to migrate to Aibaba AI 0.2, please downgrade to version 0.0.29 "
        "of the aibaba_ai_cli.\n\n"
        "🔄 You will need to run the migration script TWICE to migrate (e.g., "
        "to update llms import from aibaba_ai, the script will first move them to "
        ...
        "imports from aibaba_ai_openai, aibaba_ai_anthropic or "
        "aibaba_ai_text_splitters you "
