...
import hexdoc_hexcellular

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexcellularPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexcellularModPlugin(branch=branch)


class HexcellularModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexcellular"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexcellular, "_templates"
