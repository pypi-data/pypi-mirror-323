...
class GVFSConfig:
    ...
    # All configurations are: 'oci_' + ocifs.core.OCIFileSystem initialization parameter names
    # more details about ocifs.core.OCIFileSystem initialization parameters
    # see https://ocifs.readthedocs.io/en/stable/ocifs.html#ocifs.core.OCIFileSystem
    GVFS_FILESYSTEM_OCI_CONFIG_PREFIX = "oci_"
    GVFS_FILESYSTEM_OCI_CONFIG = "oci_config"
