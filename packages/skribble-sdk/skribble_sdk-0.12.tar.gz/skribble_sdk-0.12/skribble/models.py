...
class SignatureResponse(BaseModel):
    ...
    Attributes:
        id (str): ID of the signature
        status (str): Status of the signature
        signer_email (EmailStr): Email of the signer
        signed_at (Optional[str]): Timestamp when the signature was completed
        visual_signature (Optional[VisualSignature]): 
    """
    id: str = Field(..., description="ID of the signature")
    status: str = Field(..., description="Status of the signature")
    signer_email: EmailStr = Field(..., description="Email of the signer")
    signed_at: Optional[str] = Field(description="Timestamp when the signature was completed")
    visual_signature: Optional[VisualSignature]

class SignatureRequestResponse(BaseModel):
    """Response containing signature request details
    
    Attributes:
        id (str): ID of the signature request
    ...
    """
    id: str = Field(..., description="ID of the signature request")
    status: str = Field(..., description="Status of the signature request")
    title: str = Field(..., description="Title of the signature request")
    message: Optional[str] = Field(description="Message sent to the participants")
