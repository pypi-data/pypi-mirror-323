...
class SharedResponseMetadata(BaseModelV1):
    ...
    representing a aibaba_ai_api response shared across all outputs in said
    response.
    """
...
class InvokeResponseMetadata(SharedResponseMetadata):
    """Represents response metadata used for just single input/output aibaba_ai_api
    responses.
    """
...
class BatchResponseMetadata(SharedResponseMetadata):
    """
    Represents response metadata used for batches of input/output aibaba_ai_api
    responses.
    """
