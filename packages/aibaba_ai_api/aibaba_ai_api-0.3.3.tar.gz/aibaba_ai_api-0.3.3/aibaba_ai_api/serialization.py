...
from aibaba_ai_core.prompts.base import StringPromptValue
from pydantic import BaseModel, Discriminator, Field, RootModel, Tag, ValidationError

from aibaba_ai_api.validation import CallbackEvent
...
class WellKnownLCSerializer(Serializer):
    ...
    This is the default serialized used by aibaba_ai_api for serializing and
