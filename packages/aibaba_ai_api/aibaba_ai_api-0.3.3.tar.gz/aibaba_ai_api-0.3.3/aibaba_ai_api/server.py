...
from aibaba_ai_api.api_handler import (
    APIHandler,
    PerRequestConfigModifier,
    TokenFeedbackConfig,
    _is_hosted,
)
from aibaba_ai_api.serialization import Serializer
    ...
    """  # noqa: E501
            ...
            for path in paths:
                if endpoint_configuration.is_playground_enabled:
                    print(
                        f'{green("aibaba_ai_api:")} Playground for chain "{path or ""}/" '
                        f'is live at:'
                    )
                    print(f'{green("aibaba_ai_api:")}  │')
                    print(f'{green("aibaba_ai_api:")}  └──> {path}/playground/')
                    print(f'{green("aibaba_ai_api:")}')
            print(f'{green("aibaba_ai_api:")} See all available routes at {app.docs_url}/')
    ...
    * /config_schema - for returning the config schema of the runnable
    ...
    Args:
        ...
        playground_type: The type of playground to serve. The default is "default".
            ...
            - chat: UX is optimized for chat-like interactions. Please review
              the README in aibaba_ai_api for more details about constraints (e.g.,
    ...
    if not isinstance(runnable, Runnable):
        raise TypeError(
            ...
            "aibaba_ai_core.runnables.Runnable."
        )
    ...
    # This is done so that folks can upgrade aibaba_ai_api without having to
