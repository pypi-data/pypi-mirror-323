...
# ./pypiUploadVer EXISTED -- forPypiVersion=0.17 -- forSysVersion=0.1 -- constant=NA
def pkgVersion():
        return '0.17'
...
####+BEGINOT: b:py3:pypi:setup/funcArgs :comment "defaults to --auto--"

setuptools.setup(
    name="bisos-pycs", # Name(),  # bisos.pycs
    version=pkgVersion(),
