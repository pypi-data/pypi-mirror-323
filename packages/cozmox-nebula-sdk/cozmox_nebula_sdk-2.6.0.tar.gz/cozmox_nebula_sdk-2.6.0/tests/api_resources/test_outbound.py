...
from cozmox_sdk.types import (
    OutboundCreateCallResponse,
    OutboundRetrieveCallResponse,
)
...
class TestOutbound:
    ...
    @parametrize
    def test_method_retrieve_call(self, client: CozmoxSDK) -> None:
        outbound = client.outbound.retrieve_call(
            call_id="1234567890",
        )
        assert_matches_type(OutboundRetrieveCallResponse, outbound, path=["response"])

    @parametrize
    def test_raw_response_retrieve_call(self, client: CozmoxSDK) -> None:
        response = client.outbound.with_raw_response.retrieve_call(
            call_id="1234567890",
        )
    ...
    @parametrize
    def test_streaming_response_retrieve_call(self, client: CozmoxSDK) -> None:
        with client.outbound.with_streaming_response.retrieve_call(
            call_id="1234567890",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncOutbound:
    ...
    @parametrize
    async def test_method_retrieve_call(self, async_client: AsyncCozmoxSDK) -> None:
        outbound = await async_client.outbound.retrieve_call(
            call_id="1234567890",
        )
        assert_matches_type(OutboundRetrieveCallResponse, outbound, path=["response"])

    @parametrize
    async def test_raw_response_retrieve_call(self, async_client: AsyncCozmoxSDK) -> None:
        response = await async_client.outbound.with_raw_response.retrieve_call(
            call_id="1234567890",
        )
    ...
    @parametrize
    async def test_streaming_response_retrieve_call(self, async_client: AsyncCozmoxSDK) -> None:
        async with async_client.outbound.with_streaming_response.retrieve_call(
            call_id="1234567890",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
