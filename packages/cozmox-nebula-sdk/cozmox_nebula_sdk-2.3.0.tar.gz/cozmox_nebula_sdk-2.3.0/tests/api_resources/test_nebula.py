...
from cozmox_sdk.types import NebulaHelloResponse, NebulaRetrieveResponse
...
class TestNebula:
    ...
    @parametrize
    def test_method_retrieve(self, client: CozmoxSDK) -> None:
        nebula = client.nebula.retrieve()
        assert_matches_type(NebulaRetrieveResponse, nebula, path=["response"])

    @parametrize
    def test_raw_response_retrieve(self, client: CozmoxSDK) -> None:
        response = client.nebula.with_raw_response.retrieve()
    ...
    @parametrize
    def test_streaming_response_retrieve(self, client: CozmoxSDK) -> None:
        with client.nebula.with_streaming_response.retrieve() as response:
...
class TestAsyncNebula:
    ...
    @parametrize
    async def test_method_retrieve(self, async_client: AsyncCozmoxSDK) -> None:
        nebula = await async_client.nebula.retrieve()
        assert_matches_type(NebulaRetrieveResponse, nebula, path=["response"])

    @parametrize
    async def test_raw_response_retrieve(self, async_client: AsyncCozmoxSDK) -> None:
        response = await async_client.nebula.with_raw_response.retrieve()
    ...
    @parametrize
    async def test_streaming_response_retrieve(self, async_client: AsyncCozmoxSDK) -> None:
        async with async_client.nebula.with_streaming_response.retrieve() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
