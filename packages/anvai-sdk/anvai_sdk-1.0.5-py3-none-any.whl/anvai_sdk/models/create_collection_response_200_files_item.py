...
T = TypeVar("T", bound="CreateCollectionResponse200FilesItem")


@_attrs_define
class CreateCollectionResponse200FilesItem:
    """
    Attributes:
        id (Union[Unset, int]):  Example: 1001.
        collection (Union[Unset, int]):  Example: 101.
        file_type (Union[Unset, str]):  Example: raw.
        file_name (Union[Unset, str]):  Example: Financial_Statement_Q1.pdf.
        file_size (Union[Unset, int]):  Example: 1048576.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_collection_response_200_files_item = cls(
            id=id,
        ...
        create_collection_response_200_files_item.additional_properties = d
        return create_collection_response_200_files_item
